...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > f.getListenerIndex(d)) {
                    ...
                    q.fn = d;
                    q.priority = l;
                    for (var A = f.length - 1; 0 <= A; A--)if (f[A].priority <= l)return f.splice(A + 1, 0, q), {removeListener: t};
                    f.unshift(q)
                }
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var m = "\x3c" + l + "\x3e", q = "\x3c/" + l + "\x3e", c = m + c.replace(d, function () {
                            return q + m
                        }) + q
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            createClass: function (a) {
                var b = a.$, c = a.base, l = a.privates || a._, d = a.proto;
                a = a.statics;
                !b && (b = function () {
                    c && this.base.apply(this, arguments)
                });
                if (l)var q = b, b = function () {
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, l = {"#": 1}, q = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a)b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (f)for (var A = 0; A < f.length; A++)b.push([a, c[d], f[A]].join("-")); else b.push([a, c[d]].join("-"));
            ...
            setStyle: function (a, b) {
                ...
                var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), A = "BackCompat" == f.$.compatMode;
                if (document.documentElement.getBoundingClientRect) {
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement, m = g.clientTop ||
                        d.$.clientTop || 0, y = g.clientLeft || d.$.clientLeft || 0, h = !0;
                ...
                e = a.getWindow();
                d = m(this, e);
                var v = m(a, e), x = this.$.offsetHeight;
                f = this.$.offsetWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, z = c.endOffset, x, k = this.guard, p = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var D = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), r = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(z) : f.getNext();
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), h = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), q = function (a) {
        ...
        var f = CKEDITOR.dom.walker.empty(), z = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            a.optimizeBookmark();
            var l = 0 === b, x = 1 == b, k = 2 == b;
            b = k || x;
            var p = a.startContainer, n = a.endContainer,
                D = a.startOffset, r = a.endOffset, F, B, t, q, M, S;
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n))p = a.document.createText(p.substring(D, r)), c.append(p); else {
                ...
                O = c;
                for (P = I; P <= J; P++)if (c = H[P], W = c.getPrevious(), c.equals(w[P]))b && (O = O.getChild(0)); else {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function a(c) {
                    var f = c.container, d = c.offset, e;
                    e = f;
                    var g = d;
                    ...
                    if (f.type == CKEDITOR.NODE_TEXT) {
                        e = f;
                        for (g = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT;)g += e.getLength();
                        e = g;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var g = this.getCommonAncestor(), h = this.root, l, x, k, p, n, D = !1, r, F;
                        ...
                        for (k = c(k); k || p;) {
                            ...
                            for (; p;)if (r = !1, p.type == CKEDITOR.NODE_COMMENT)p = p.getPrevious(); else {
                                if (p.type == CKEDITOR.NODE_TEXT)F = p.getText(), d.test(F) && (p = null), r = /[\s\ufeff]$/.test(F); else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    F =
                                        p.getText();
                                    if (d.test(F))p = null; else for (var B = p.$.getElementsByTagName("*"), t = 0, q; q = B[t++];)if (!CKEDITOR.dtd.$removeEmpty[q.nodeName.toLowerCase()]) {
                                        p = null;
                                        break
                                    }
                                    p && (r = !!F.length)
                        ...
                        for (; k || p;) {
                            ...
                            for (; p;) {
                                r = !1;
                                if (p.type == CKEDITOR.NODE_TEXT)F = p.getText(), m(p, 0) || (p = null), r = /^[\s\ufeff]/.test(F); else if (p.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < p.$.offsetWidth || b && p.is("br")) && !p.data("cke-bookmark"))if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                        F =
                                            p.getText();
                                        if (d.test(F))p = null; else for (B = p.$.getElementsByTagName("*"), t = 0; q = B[t++];)if (!CKEDITOR.dtd.$removeEmpty[q.nodeName.toLowerCase()]) {
                                            p = null;
                                            break
                                        }
                                        p && (r = !!F.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var M, S, w = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), H = null, I = function (a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            k = this.clone();
                            k = new CKEDITOR.dom.walker(k);
                            var G = CKEDITOR.dom.walker.whitespaces(), J = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, m = this.endContainer, g = this.startOffset, h = this.endOffset, l = 1, x = 1;
            ...
            setEndAt: function (b, c) {
                ...
                if (a && !a.is(CKEDITOR.dtd.$block))d = 1; else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())d = 1, (m = e.type ==
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = m.startPath();
                    var y = m.endPath(), E = !m.collapsed && c(m, h.block), v = !m.collapsed && c(m, y.block, 1);
                ...
                for (this._.nextNode = null; y;) {
                    var E = 0, v = y.hasAscendant("pre"), x = y.type != CKEDITOR.NODE_ELEMENT, k = 0;
                    if (x)y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (x = 0); else {
                        var p = y.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) {
                            ...
                            if ("br" == p)x = 1; else if (!h && !y.getChildCount() && "hr" != p) {
                                d = y;
                                A = y.equals(m);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (k in b) {
                ...
                for (m in S) {
                    n[m] = h(n[m], r) || null;
                    var G = n, f = w[m], x = h(n[w[m]], r), g = n[m], D = [], F = !0, J = void 0;
                    x ? F = !1 : x = {};
        ...
        function u(a, b, k, e) {
            ...
            if (e.doFilter) {
                ...
                if (!a || !a.valid)return k.push(b), 1;
                h = a.validAttributes;
                var F = a.validStyles;
                r = a.validClasses;
                var f = b.attributes, l = b.styles, x = b.classes;
                g = b.classBackup;
                var I = b.styleBackup, B, H, O = [], D = [], L = /^data-cke-/;
                w = !1;
                delete f.style;
                delete f["class"];
        ...
        function k(a, b, c) {
            ...
            if (B.$empty[d] || !a.children.length)"hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (B.$block[d] || "tr" == d)if ("br" == b)a.previous && !x(a.previous) && (b = v(), b.insertBefore(a)), a.next && !x(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, k;
                b:{
                    k = B[b];
        ...
        function n(a, b) {
            var c = b.getDefinition(), d = c.attributes, k = c.styles, e, p, n, r;
        ...
        var B = CKEDITOR.dtd, L = CKEDITOR.tools.copy, T = CKEDITOR.tools.trim, M = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, p = [], n = this.editor && this.editor.config.protectedSource, r, f = !1, m = {
                    doFilter: !c,
                    doTransform: !0,
                    doCallbacks: !0,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (r = u(e, a, p, m), r & 1)f = !0; else if (r & 2)return !1
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        b = a[k];
                        var e = void 0, p = void 0, n = void 0, f = void 0, x = void 0, m = void 0;
                        c = [];
                ...
                var n = CKEDITOR.tools.clone(k), r = [], x;
                if (!1 !== b && (x = this._.transformations[k.name])) {
                    for (d =
                             0; d < x.length; ++d)p(this, k, x[d]);
                    m(k)
                }
                u(this, n, r, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var S = {styles: 1, attributes: 1, classes: 1}, w = {
                ...
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b)a.name = b; else {
                        var c = b.getDefinition(), d = c.styles,
                            k = c.attributes, e, p, n, r;
                        a.name = c.element;
                        for (e in k)if ("class" == e)for (c = a.classes.join("|"), n = k[e].split(/\s+/); r = n.pop();)-1 == c.indexOf(r) && a.classes.push(r); else a.attributes[e] = k[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, g) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var l = b.length, q = [], t = [], f = function (a) {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, l = {}, q = 0; q < a.length; q++) {
                var t = a[q];
                if (t)if (c[t] || e[t])l[t] = this.get(t); else {
    ...
    (function () {
        ...
        function z(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var f in c) {
                    var x = c[f], g = x.lang, h = null, l = x.requires, w;
            ...
            function (g, h, l) {
                function q(a) {
                    ...
                    if (0 < y.length)for (var c = 0; c < y.length; c++) {
                        var d = y[c], k = d.name, e = CKEDITOR.dtd[k], f = v.name && CKEDITOR.dtd[v.name];
                ...
                var C = new CKEDITOR.htmlParser, m = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, y = [], E = [], v = m, x = "textarea" == m.name, k = "pre" == m.name;
                C.onTagOpen = function (e, n, f, r) {
                    ...
                    if (a(n))y.push(n); else {
                        ...
                        if ("br" == e)E.push(n); else {
                            for (; !(r = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || v.isUnknown || r[e]);)if (v.isOptionalClose)C.onTagClose(f); else if (e in b && f in b)f = v.children, (f = f[f.length - 1]) && "li" == f.name || z(f = new CKEDITOR.htmlParser.element("li"), v), !n.returnPoint && (n.returnPoint = v), v = f; else if (e in CKEDITOR.dtd.$listItem && !u(e, f))C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !u(e, f))!n.returnPoint && (n.returnPoint = v), v = v.parent; else if (f in CKEDITOR.dtd.$inline && y.unshift(v), v.parent)z(v, v.parent, 1); else {
                                n.isOrphan = 1;
                                break
                            }
                            q(e);
                ...
                C.onText = function (a) {
                    ...
                    if (!x && !f["#"] && b in d)C.onTagOpen(e[b] || ""), C.onText(a); else {
                        t();
                        q();
                        k || x || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), h = this.rules, l = h.length, q, t, f, z;
                for (z = 0; z < l; z++)if (d && (q = c.type, t = c.name), f = h[z], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            var r = {elements: {}}, x = "html" == d, w = CKEDITOR.tools.extend({}, k), D;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, k, c = m(c, b), c = f(c, M), c = t(c), c = f(c, T), c = c.replace(w, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        }, n = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, D = {
            elements: {
                embed: function (a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
        ...
        var F = /<(a|area|img|input|source)\b([^>]*)>/gi, B = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, L = /^(href|src|name)$/i, T = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var q, t;
                for (q in h) {
                    for (l = h[q]; ;)if (t = a.onAttributeName(b, q))if (t != q)delete h[q], q = t; else break; else {
                        delete h[q];
                        break
                    }
                ...
                b && this.filter(b);
                var g = this.name, h = [], l = this.attributes, q, t;
                a.openTag(g, l);
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    var l = d.checkDirty(), h = d._.previousModeData, q, t = 0;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var l = this.container, q = this.ui.space("contents"), t = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, n = e.blockLimit, f = a.data.selection, r = f.getRanges()[0], F;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var h, g;
                    if (f)for (; (h = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[h.getName()]) &&
                    ...
                    function a() {
                        var b = c.getDocument().$, d = b.getSelection(), k;
                        a:if (d.anchorNode && d.anchorNode == c.$)k = !0; else {
                    ...
                    function b() {
                        var a = c.getDocument().$, d = a.selection, k = c.getDocument().getActive();
                ...
                extractHtmlFromRange: function (a, b) {
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                                var d = c.block.getElementsByTag("span"), f = 0, h;
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in h) {
                                b = a.getSelection();
                                var k, e = b.getRanges()[0], n = e.startPath(), p, w, l, c = 8 == c;
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0), z = CKEDITOR.dom.walker.bookmark(!1, !0), A = CKEDITOR.dom.walker.empty(), u = CKEDITOR.dom.walker.bogus(), C = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, m = function () {
            ...
            function b(c, d) {
                var e, f, n, p, h = [], r = d.range.startContainer;
                e = d.range.startPath();
                ...
                l; ++g)e = D.getItem(g), a(e) ? (n = e.getName(), q && n in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !!r[n], "br" != n || !e.data("cke-eol") || g && g != l - 1 || (t = (f = g ? h[g - 1].node : D.getItem(g + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != F || p || (F = g), p || (m = g), h.push({
                    ...
                    name: n,
                    allowed: p
                }), f = t = 0)) : h.push({isElement: 0, node: e, allowed: 1});
            ...
            function d(b, c) {
                var e = [],
                    k = b.getChildren(), f = k.count(), n, h = 0, r = B[c], g = !b.is(B.$inline) || b.is("br");
            ...
            function g(b, c) {
                ...
                var e = c.endContainer.getChild(c.endOffset), k = c.endContainer.getChild(c.endOffset - 1);
                e && d(e, b[b.length - 1]);
                k && d(k, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse())
            }

            var B = CKEDITOR.dtd, m = {
            ...
            return function (m, w, H, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    I = m.mergeCandidates;
                    var K, u;
                    "text" == m.type && w.shrink(CKEDITOR.SHRINK_ELEMENT,
                        !0, !1) && (K = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", w.document), w.insertNode(K), w.setStartAfter(K));
                    J = new CKEDITOR.dom.elementPath(w.startContainer);
                    m.endPath = L = new CKEDITOR.dom.elementPath(w.endContainer);
                    if (!w.collapsed) {
                        var G = L.block || L.blockLimit, y = w.getCommonAncestor();
                    ...
                    for (G = K.startNode; (G = G.getParent()) && f(G);)I.push(G);
                    w.moveToBookmark(K);
                    if (K = H) {
                        K = m.range;
                    ...
                    if (K) {
                        ...
                        var R, X;
                        w = z.startContainer;
                        var J = m.endPath.elements[0], Y, L = J.getPosition(w),
                            ...
                            if (v)H = 0 < I; else {
                                ...
                                if (G && L.isElement) {
                                    ...
                                    if (v)R && (X = z.splitElement(R),
                                        m.zombies.push(X), m.zombies.push(R)); else {
                                        R = u.getName();
                                        Y = !I;
                                        v = I == w.length - 1;
                                        R = d(L.node, R);
            ...
            bogus: {
                ...
                rebuild: function (a, b) {
                    var c = a.range, d = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(d, b), f = new CKEDITOR.dom.elementPath(c.startContainer, b), c = new CKEDITOR.dom.elementPath(c.endContainer, b), h;
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark),
                            e = d.startPath(), f = d.endPath(), k = e.contains(CKEDITOR.dtd.$list), h = f.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode,
                                e = a.mergeListBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c), h = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                                var p = f.contains(CKEDITOR.dtd.$list), g = h.contains(CKEDITOR.dtd.$list);
                    ...
                    detectMerge: function (a, b) {
                        ...
                        if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                            var d = a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode, f = new CKEDITOR.dom.elementPath(d, c), h = new CKEDITOR.dom.elementPath(e, c), f = f.block, h = h.block;
                    ...
                    function a(c) {
                        var e = [], f, k = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), n = c.endPath().contains(d), p = {};
                        k.guard = function (a,
                                            k) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (k && h && a.equals(h))f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!k && n && a.equals(n))f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var k = c(f, e.bookmark), h = k.clone(), g, l, w = k.getCommonAncestor();
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, k = CKEDITOR.document, g = e.editable(), p = f.getBody(), l = f.getDocumentElement(), m = g.isInline(), w, H;
        ...
        var E = "function" != typeof window.getSelection, v = 1;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                var a = E ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, k, h = b.duplicate(), g = 0,
                                 w = e.length - 1, l = -1, n, m; g <= w;)if (l = Math.floor((g + w) / 2), f = e[l], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n)w = l - 1; else if (0 > n)g = l + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                ...
                var b = this.getNative(), b = E ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                        ...
                        if (E) {
                            ...
                            for (u = 0; u < a.length; u++) {
                                ...
                                try {
                                    ...
                                    if (0 <= H.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))g.collapse(1), q.setEnd(g.endContainer.$, g.endOffset); else throw H;
                                }
                                f.addRange(q)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var f = c.document;
            if (c.collapsed)f = E(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                var h = this.element, g = this._.definition, k, l = g.ignoreReadonly, m = l || g.includeReadonly;
                null ==
                ...
                c.trim();
                var p = c.createBookmark(), t = p.startNode, q = p.endNode, r = t, u;
                if (!l) {
                    var x = c.getCommonAncestor(), l = a(t, x), x = a(q, x);
                    l && (r = l.getNextSourceNode(!0));
                    x && (q = x)
                }
                for (r.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    l = !1;
                    if (r.equals(q))r = null, l = !0; else {
                        ...
                        if (x && m && CKEDITOR.dtd.$block[v])for (var A = r, y = e(A), B = void 0, D = y.length, F = 0, A = D && new CKEDITOR.dom.range(A.getDocument()); F < D; ++F) {
                            var B = y[F], T = CKEDITOR.filter.instances[B.data("cke-filter")];
                            if (T ? T.check(this) : 1)A.selectNodeContents(B), b.call(this, A)
                        }
                        y = v ? !n[v] || z ? 0 : x && !m ? 0 : d(r, q, g, M) : 1;
                        if (y)if (B = r.getParent(), y = g, D = h, F = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !F || y.parentRule && !y.parentRule(B))l = !0; else {
                            if (u ||
                                ...
                                for (var v = r, Z; (l = !v.getNext(L)) && (Z = v.getParent(), n[Z.getName()]) && d(Z, t, g, S);)v = Z;
                                u.setEndAfter(v)
                            }
                        } else l = !0;
        ...
        var D = {
            ...
            audio: 1,
            video: 1
        }, F = /\s*(?:;\s*|$)/, B = /#\((.+?)\)/g, L = CKEDITOR.dom.walker.bookmark(0, 1), T = CKEDITOR.dom.walker.whitespaces(1);
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset", q = g ? c.document.getById(a.startNode) : a.startNode;
                        ...
                        if (l && 1 < a.length) {
                            ...
                            if (h)for (var t = 0; a[g + t + 1];) {
                                ...
                                for (f = f.getById(d[t + 1].startNode); ;) {
                                    ...
                                    if (f.equals(q))h = 1; else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary())continue;
                                    break
                                }
                                if (!h)break;
                                t++
    ...
    (function () {
        ...
        var h = "cke_ui_color", l = [], q = /\$color/g;
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,horizontalrule,htmlwriter,iframe,wysiwygarea,image,indent,indentblock,indentlist,smiley,justify,menubutton,language,link,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,scayt,stylescombo,tab,table,tabletools,undo,wsc';
