...
teacss.ui.editorPanel = (function ($) {
    return teacss.ui.panel.extend({
        ...
        init: function (options) {
            ...
            this.tabsForFiles.bind("select", function () {
                me.saveTabs()
            });
            this.tabsForFiles.bind("sortstop", function () {
                me.saveTabs()
            });
