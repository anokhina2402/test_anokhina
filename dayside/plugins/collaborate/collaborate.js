/*! @license Firebase v2.0.2 - License: https://www.firebase.com/terms/terms-of-service.html */
(function () {
    var h, aa = this;
    ...
    function Fa() {
        ...
        this.Dd = [];
        this.Dd[0] = 128;
        for (var a = 1; a < this.Sa; ++a)this.Dd[a] = 0;
        this.Rd = this.Tb = 0;
        this.reset()
    }
    ...
    Fa.prototype.update = function (a, b) {
        n(b) || (b = a.length);
        for (var c = b - this.Sa, d = 0, e = this.be, f = this.Tb; d < b;) {
            if (0 == f)for (; d <= c;)Ga(this, a, d), d += this.Sa;
            if (p(a))for (; d < b;) {
    ...
    function eb(a, b) {
        ...
        if (!cb) {
            cb = {};
            db = {};
            for (var c = 0; 65 > c; c++)cb[c] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c), db[c] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c)
        }
    ...
    function hb(a) {
        try {
            ...
            ib("base64DecodeIfNativeSupport failed: ", b)
        }
        return null
    }
    ...
    function jb(a) {
        ...
        a.update(b);
        var b = [], c = 8 * a.Rd;
        56 > a.Tb ? a.update(a.Dd, 56 - a.Tb) : a.update(a.Dd, a.Sa - (a.Tb - 56));
    ...
    function lb(a) {
        for (var b = "", c = 0; c < arguments.length; c++)b = fa(arguments[c]) ? b + lb.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + t(arguments[c]) : b + arguments[c], b += " ";
        return b
    }
    ...
    function ib(a) {
        !0 === nb && (nb = !1, null === mb && !0 === Ba.get("logging_enabled") && ob(!0));
        if (mb) {
    ...
    function sb(a) {
        ...
        return {
            host: b,
            domain: c, ug: d, Cb: e, scheme: f, Pc: g
        }
    }
    ...
    function yb(a) {
        ...
        b.sort();
        c = "{";
        for (var d = 0; d < b.length; d++)0 !== d && (c += ","), c += t(b[d]), c += ":", c += yb(a[b[d]]);
        return c + "}"
    }
    ...
    Eb.prototype.oe = function () {
        return this.nd
    };
    Eb.prototype.Pb = function () {
    ...
    h.createEvent = function (a, b) {
        var c = b.u.w;
        return new Eb("value", this, new C(a.Wa, b.hc(), c))
    };
    h.Pb = function (a) {
        var b = this.vc;
        if ("cancel" === a.oe()) {
    ...
    h.Te = function (a, b) {
        return this.mb ? new Fb(this, a, b) : null
    };
    h.matches = function (a) {
        return a instanceof Gb && (!a.Kb || !this.Kb || a.Kb === this.Kb) && a.vc === this.vc
    };
    h.cf = function () {
        return null !== this.Kb
    };
    ...
    h.matches = function (a) {
        if (a instanceof Hb) {
            if (this.ca && a.ca) {
                ...
                if (b === Ib(this.ca)) {
                    if (1 === b) {
                        var b = Jb(a.ca), c = Jb(this.ca);
                        return c === b && (!a.ca[b] || !this.ca[c] || a.ca[b] === this.ca[c])
                    }
                    return Kb(this.ca, function (b, c) {
                        return a.ca[c] === b
                    })
                }
                return !1
    ...
    function Ob(a) {
        return p(a) && 0 !== a.length && !Mb.test(a)
    }

    function Pb(a) {
        return null === a || p(a) || ga(a) && !tb(a) || ia(a) && u(a, ".sv")
    }
    ...
    function Rb(a, b, c, d) {
        c || (c = 0);
        d = d || [];
        if (!n(b))throw Error(a + "contains undefined" + Sb(d));
        if (ha(b))throw Error(a + "contains a function" + Sb(d) + " with contents: " + b.toString());
        if (tb(b))throw Error(a + "contains " + b.toString() + Sb(d));
        if (1E3 < c)throw new TypeError(a + "contains a cyclic object value (" + d.slice(0, 100).join(".") + "...)");
        if (p(b) && b.length > 10485760 / 3 && 10485760 < kb(b).length)throw Error(a + "contains a string greater than 10485760 utf8 bytes" + Sb(d) + " ('" + b.substring(0, 50) + "...')");
        if (ia(b))for (var e in b)if (u(b,
                e)) {
            var f = b[e];
            if (".priority" !== e && ".value" !== e && ".sv" !== e && !Ob(e))throw Error(a + " contains an invalid key (" + e + ")" + Sb(d) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            d.push(e);
            Rb(a, f, c + 1, d);
            d.pop()
        }
    ...
    function Ub(a, b, c) {
        if (tb(c))throw Error(E(a, b, !1) + "is " + c.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
        if (!Pb(c))throw Error(E(a, b, !1) + "must be a valid Firebase priority (a string, finite number, server value, or null).");
    }
    ...
    function Xb(a, b) {
        if (!p(b) || 0 === b.length || Nb.test(b))throw Error(E(a, 1, !1) + 'was an invalid path: "' + b + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
    }
    ...
    h.ze = function () {
        var a = K.I(this.Vb, ic);
        return new I("[MAX_NAME]", a)
    };
    h.toString = function () {
        return this.Vb
    };
    var L = new hc(".priority");
    ...
    function lc() {
        this.yc = this.sa = this.nc = this.la = this.ja = !1;
        this.xb = 0;
        this.Hb = "";
        this.Bc = null;
        this.Xb = "";
    ...
    function nc(a) {
        x(a.la, "Only valid if start has been set");
        return a.Bc
    }
    ...
    function pc(a) {
        x(a.sa, "Only valid if end has been set");
        return a.Ac
    }
    ...
    function rc(a) {
        x(a.ja, "Only valid if limit has been set");
        return a.xb
    }
    ...
    function vc(a) {
        if (a.w === kc) {
            if (a.la) {
                var b = nc(a);
                if ("[MIN_NAME]" != oc(a) || null != b && "string" !== typeof b)throw Error("Query: You must use startAt(), endAt() or equalTo() with a single string in combination with orderByKey(). Other values or more parameters are not supported.");
            }
            if (a.sa && (b = pc(a), "[MAX_NAME]" != qc(a) || null != b && "string" !== typeof b))throw Error("Query: You must use startAt(), endAt() or equalTo() with a single string in combination with orderByKey(). Other values or more parameters are not supported.");
        }
    }

    function wc(a) {
        if (a.la && a.sa && a.ja && (!a.ja || "" === a.Hb))throw Error("Query: Can't combine startAt(), endAt(), and limit(). Use limitToFirst() or limitToLast() instead.");
    }
    ...
    M.prototype.zb = function (a, b, c, d) {
        ...
        Vb("Query.on", a, !1);
        F("Query.on", 2, b, !1);
        var e = yc("Query.on", c, d);
        if ("value" === a)zc(this.g, this, new Gb(b, e.cancel || null, e.Ha || null)); else {
            var f = {};
            f[a] = b;
            zc(this.g, this, new Hb(f, e.cancel, e.Ha))
        }
        return b
    };
    ...
    M.prototype.bc = function (a, b, c) {
        ...
        Lb("Query.off", 3, c);
        var d = null, e = null;
        "value" === a ? d = new Gb(b || null, null, c || null) : a && (b && (e = {}, e[a] = b), d = new Hb(e, null, c || null));
        e = this.g;
    ...
    M.prototype.fg = function (a, b) {
        ...
        Vb("Query.once", a, !1);
        F("Query.once", 2, b, !1);
        var d = yc("Query.once", arguments[2], arguments[3]), e = this, f = !0;
        this.zb(a, c, function (b) {
            e.bc(a, c);
            d.cancel && d.cancel.call(d.Ha, b)
        })
    };
    M.prototype.once = M.prototype.fg;
    M.prototype.ve = function (a) {
        ...
        if (this.u.ja)throw Error("Query.limit: Limit was previously set");
        var b = this.u.ve(a);
        wc(b);
    ...
    M.prototype.we = function (a) {
        ...
        if (this.u.ja)throw Error("Query.limitToFirst: Limit was previously set");
        return new M(this.g, this.path, this.u.we(a), this.dc)
    };
    ...
    M.prototype.xe = function (a) {
        ...
        if (this.u.ja)throw Error("Query.limitToLast: Limit was previously set");
        return new M(this.g, this.path, this.u.xe(a), this.dc)
    };
    ...
    M.prototype.gg = function (a) {
        ...
        Wb("Query.orderByChild", 1, a, !1);
        xc(this, "Query.orderByChild");
        return new M(this.g, this.path, tc(this.u, new hc(a)), !0)
    };
    M.prototype.orderByChild = M.prototype.gg;
    M.prototype.hg = function () {
        D("Query.orderByKey", 0, 0, arguments.length);
        xc(this, "Query.orderByKey");
        var a = tc(this.u, kc);
        vc(a);
        return new M(this.g, this.path, a, !0)
    };
    M.prototype.orderByKey = M.prototype.hg;
    M.prototype.ig = function () {
        D("Query.orderByPriority", 0, 0, arguments.length);
        xc(this, "Query.orderByPriority");
        return new M(this.g, this.path, tc(this.u, L), !0)
    };
    M.prototype.orderByPriority = M.prototype.ig;
    M.prototype.Md = function (a, b) {
        D("Query.startAt", 0, 2, arguments.length);
        Qb("Query.startAt", a, !0);
        Wb("Query.startAt", 2, b, !0);
        var c = this.u.Md(a, b);
        wc(c);
        vc(c);
        if (this.u.la)throw Error("Query.startAt: startAt() or equalTo() previously called");
        n(a) || (b = a = null);
    ...
    M.prototype.md = function (a, b) {
        ...
        Qb("Query.endAt", a, !0);
        Wb("Query.endAt", 2, b, !0);
        var c = this.u.md(a, b);
        wc(c);
        vc(c);
        if (this.u.sa)throw Error("Query.endAt: endAt() or equalTo() previously called");
        return new M(this.g, this.path, c, this.dc)
    };
    M.prototype.endAt = M.prototype.md;
    M.prototype.Of = function (a, b) {
        D("Query.equalTo", 1, 2, arguments.length);
        Qb("Query.equalTo", a, !1);
        Wb("Query.equalTo", 2, b, !0);
        if (this.u.la)throw Error("Query.equalTo: startAt() or equalTo() previously called!");
        if (this.u.sa)throw Error("Query.equalTo: endAt() or equalTo() previously called!");
    ...
    function Bc(a) {
        a = a.u;
        var b = {};
        a.la && (b.sp = a.Bc, a.nc && (b.sn = a.Xb));
        a.sa && (b.ep = a.Ac, a.yc && (b.en = a.Ub));
        if (a.ja) {
            b.l = a.xb;
            var c = a.Hb;
            "" === c && (c = a.la ? "l" : "r");
    ...
    function yc(a, b, c) {
        ...
        if (b && c)d.cancel = b, F(a, 3, d.cancel, !0), d.Ha = c, Lb(a, 4, d.Ha); else if (b)if ("object" === typeof b && null !== b)d.Ha = b; else if ("function" === typeof b)d.cancel = b; else throw Error(E(a, 3, !0) + " must either be a cancel callback or a context object.");
        return d
    };
    function P(a, b) {
        if (1 == arguments.length) {
            this.m = a.split("/");
            for (var c = 0, d = 0; d < this.m.length; d++)0 < this.m[d].length && (this.m[c] = this.m[d], c++);
            this.m.length = c;
            this.ba = 0
        } else this.m = a, this.ba = b
    }

    function G(a) {
        return a.ba >= a.m.length ? null : a.m[a.ba]
    }

    function Q(a) {
        return a.m.length - a.ba
    }
    ...
    P.prototype.toString = function () {
        for (var a = "", b = this.ba; b < this.m.length; b++)"" !== this.m[b] && (a += "/" + this.m[b]);
        return a || "/"
    };
    P.prototype.parent = function () {
        if (this.ba >= this.m.length)return null;
        for (var a = [], b = this.ba; b < this.m.length - 1; b++)a.push(this.m[b]);
        return new P(a, 0)
    };
    P.prototype.k = function (a) {
        for (var b = [], c = this.ba; c < this.m.length; c++)b.push(this.m[c]);
        if (a instanceof P)for (c = a.ba; c < a.m.length; c++)b.push(a.m[c]); else for (a = a.split("/"), c = 0; c < a.length; c++)0 < a[c].length && b.push(a[c]);
        return new P(b, 0)
    };
    P.prototype.e = function () {
        return this.ba >= this.m.length
    };
    var S = new P("");
    ...
    P.prototype.ea = function (a) {
        ...
        for (var b = this.ba, c = a.ba; b <= this.m.length; b++, c++)if (this.m[b] !== a.m[c])return !1;
        return !0
    };
    ...
    function Ec(a, b) {
        for (var c = b instanceof P ? b : new P(b), d = a, e; null !== (e = G(c));)d = new Dc(e, d, v(d.G.children, e) || new Cc), c = R(c);
        return d
    }
    ...
    function Gc(a) {
        if (null !== a.Oc) {
            var b = a.Oc, c = a.yd, d = a.e(), e = u(b.G.children, c);
            d && e ? (delete b.G.children[c], b.G.dd--, Gc(b)) : d || e || (b.G.children[c] = a.G, b.G.dd++, Gc(b))
        }
    };
    function Jc(a, b) {
        this.Ga = a;
    ...
    h = Jc.prototype;
    h.Ja = function (a, b) {
        return new Jc(this.Ga, this.oa.Ja(a, b, this.Ga).W(null, null, !1, null, null))
    };
    h.remove = function (a) {
        return new Jc(this.Ga, this.oa.remove(a, this.Ga).W(null, null, !1, null, null))
    };
    h.get = function (a) {
        for (var b, c = this.oa; !c.e();) {
            b = this.Ga(a, c.key);
    ...
    h.Aa = function (a) {
        return new Mc(this.oa, null, this.Ga, !1, a)
    };
    h.rb = function (a, b) {
        return new Mc(this.oa, a, this.Ga, !1, b)
    };
    h.Sb = function (a, b) {
        return new Mc(this.oa, a, this.Ga, !0, b)
    };
    h.bf = function (a) {
        return new Mc(this.oa, null, this.Ga, !0, a)
    };
    ...
    function Nc(a, b, c, d, e) {
        ...
        this.left = null != d ? d : Kc;
        this.right = null != e ? e : Kc
    }

    h = Nc.prototype;
    h.W = function (a, b, c, d, e) {
        return new Nc(null != a ? a : this.key, null != b ? b : this.value, null != c ? c : this.color, null != d ? d : this.left, null != e ? e : this.right)
    };
    h.count = function () {
    ...
    function Qc(a) {
        if (a.left.e())return Kc;
        a.left.aa() || a.left.left.aa() || (a = Rc(a));
        a = a.W(null, null, null, Qc(a.left), null);
        return Pc(a)
    }
    ...
    h.remove = function (a, b) {
        var c, d;
        c = this;
        if (0 > b(a, c.key))c.left.e() || c.left.aa() || c.left.left.aa() || (c = Rc(c)), c = c.W(null, null, null, c.left.remove(a, b), null); else {
            c.left.aa() && (c = Sc(c));
            c.right.e() || c.right.aa() || c.right.left.aa() || (c = Tc(c), c.left.left.aa() && (c = Sc(c), c = Tc(c)));
            if (0 === b(a, c.key)) {
                if (c.right.e())return Kc;
                d = Oc(c.right);
                c = c.W(d.key, d.value, null, null, Qc(c.right))
            }
    ...
    function Pc(a) {
        a.right.aa() && !a.left.aa() && (a = Uc(a));
        a.left.aa() && a.left.left.aa() && (a = Sc(a));
        a.left.aa() && a.right.aa() && (a = Tc(a));
        return a
    }

    function Rc(a) {
        a = Tc(a);
        a.right.left.aa() && (a = a.W(null, null, null, null, Sc(a.right)), a = Uc(a), a = Tc(a));
        return a
    }
    ...
    h.ib = function (a) {
        return new Xc(this.A, a)
    };
    h.B = function (a) {
        return ".priority" === a ? this.ha : K
    };
    h.$ = function (a) {
        return a.e() ? this : ".priority" === G(a) ? this.ha : K
    };
    h.Y = function () {
        return !1
    };
    ...
    h.I = function (a, b) {
        return ".priority" === a ? this.ib(b) : K.I(a, b).ib(this.ha)
    };
    h.L = function (a, b) {
        var c = G(a);
        if (null === c)return b;
    ...
    h.hash = function () {
        if (null === this.wb) {
            var a = "";
            this.ha.e() || (a += "priority:" + Zc(this.ha.N()) + ":");
            var b = typeof this.A, a = a + (b + ":"), a = "number" === b ? a + Bb(this.A) : a + this.A;
            this.wb = jb(a)
        }
        return this.wb
    };
    ...
    Xc.prototype.ea = function (a) {
        return a === this ? !0 : a.P() ? this.A === a.A && this.ha.ea(a.ha) : !1
    };
    ...
    function cd(a, b, c) {
        var d = dd(a.td, function (d, f) {
            var g = v(a.Wb, f);
            x(g, "Missing index implementation for " + f);
            if (d === fc) {
                if (g.se(b.K)) {
                    for (var k = [], l = c.Aa(Wc), m = U(l); m;)m.name != b.name && k.push(m), m = U(l);
                    k.push(b);
                    return ed(k, H(g))
                }
                return fc
        ...
        return new bd(d, a.Wb)
    }

    function fd(a, b, c) {
        var d = dd(a.td, function (a) {
            if (a === fc)return a;
            var d = c.get(b.name);
    ...
    var gd = new bd({".priority": fc}, {".priority": L});

    function $c(a, b, c) {
        this.j = a;
        (this.ha = b) && Yc(this.ha);
        this.sb = c;
        this.wb = null
    }
    ...
    h.I = function (a, b) {
        ...
        var c = new I(a, b), d;
        b.e() ? (d = this.j.remove(a), c = fd(this.sb, c, this.j)) : (d = this.j.Ja(a, b), c = cd(this.sb, c, this.j));
        return new $c(d, this.ha, c)
    };
    h.L = function (a, b) {
        var c = G(a);
        if (null === c)return b;
    ...
    h.N = function (a) {
        ...
        var b = {}, c = 0, d = 0, e = !0;
        this.fa(L, function (f, g) {
            b[f] = g.N(a);
            c++;
            e && hd.test(f) ? d = Math.max(d, Number(f)) : e = !1
        });
        if (!a && e && d < 2 * c) {
            var f = [], g;
            for (g in b)f[g] = b[g];
    ...
    h.hash = function () {
        if (null === this.wb) {
            var a = "";
            this.O().e() || (a += "priority:" + Zc(this.O().N()) + ":");
            this.fa(L, function (b, c) {
                var d = c.hash();
                "" !== d && (a += ":" + b + ":" + d)
            });
            this.wb = "" === a ? "" : jb(a)
    ...
    h.af = function (a, b, c) {
        return (c = id(this, c)) ? (a = Lc(c, new I(a, b))) ? a.name : null : Lc(this.j, a)
    };
    function jd(a, b) {
        var c;
        c = (c = id(a, b)) ? (c = c.Ic()) && c.name : a.j.Ic();
        return c ? new I(c, a.j.get(c)) : null
    }

    function kd(a, b) {
        var c;
        c = (c = id(a, b)) ? (c = c.Zb()) && c.name : a.j.Zb();
        return c ? new I(c, a.j.get(c)) : null
    }
    ...
    h.he = function (a) {
        return this.e() ? a.e() ? 0 : -1 : a.P() || a.e() ? 1 : a === ic ? -1 : 0
    };
    h.Wd = function (a) {
        if (a === kc || ld(this.sb.Wb, a.toString()))return this;
        var b = this.sb, c = this.j;
        x(a !== kc, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
        for (var d = [], e = !1, c = c.Aa(Wc), f = U(c); f;)e = e || a.se(f.K), d.push(f), f = U(c);
        d = e ? ed(d, H(a)) : fc;
        e = a.toString();
        c = md(b.Wb);
        c[e] = a;
        a = md(b.td);
        a[e] = d;
        return new $c(this.j, this.ha, new bd(a, c))
    };
    h.Yb = function (a) {
        return a === kc || ld(this.sb.Wb, a.toString())
    };
    h.ea = function (a) {
        if (a === this)return !0;
        if (a.P())return !1;
        if (this.O().ea(a.O()) && this.j.count() === a.j.count()) {
            var b = this.Aa(L);
            a = a.Aa(L);
            for (var c = U(b), d = U(a); c && d;) {
                if (c.name !== d.name || !c.K.ea(d.K))return !1;
                c = U(b);
                d = U(a)
            }
    ...
    function id(a, b) {
        return b === kc ? null : a.sb.get(b.toString())
    }

    h.toString = function () {
        var a = "{", b = !0;
        this.fa(L, function (c, d) {
            b ? b = !1 : a += ", ";
            a += '"' + c + '" : ' + d.toString()
        });
        return a += "}"
    ...
    function J(a, b) {
        ...
        if ("object" !== typeof a || ".sv"in a)return new Xc(a, J(c));
        ...
        var l = ed(f, cc, function (a) {
            return a.name
        }, dc);
        if (g) {
            var m = ed(f, H(L));
            return new $c(l, J(c), new bd({".priority": m}, {".priority": L}))
        }
        return new $c(l, J(c), gd)
    }

    var nd = Math.log(2);

    function od(a) {
        this.count = parseInt(Math.log(a + 1) / nd, 10);
    ...
    function ed(a, b, c, d) {
        ...
        var f = function (b) {
            function d(b, g) {
                var k = r - b, s = r;
                r -= b;
                var s = e(k + 1, s), k = a[k], y = c ? c(k) : k, s = new Nc(y, k.K, g, null, s);
                f ? f.left = s : m = s;
                f = s
            }

            for (var f = null, m = null, r = a.length, s = 0; s < b.count; ++s) {
                var y = pd(b), N = Math.pow(2, b.count - (s + 1));
                y ? d(N, !1) : (d(N, !1), d(N, !0))
            }
            return m
        }(new od(a.length));
        return null !== f ? new Jc(d || b, f) : new Jc(d || b)
    }
    ...
    function Yc(a) {
        ...
        } else x(a === ic || a.e(), "priority of unexpected type.");
        x(a === ic || a.O().e(), "Priority nodes can't have a priority of their own.")
    }

    var K = new $c(new Jc(dc), null, gd);

    function qd() {
        $c.call(this, new Jc(dc), K, gd)
    }
    ...
    var ic = new qd, gc = new I("[MIN_NAME]", K);
    ...
    C.prototype.numChildren = C.prototype.Ta;
    ...
    var Bd = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");

    function Cd(a, b) {
        for (var c, d, e = 1; e < arguments.length; e++) {
            d = arguments[e];
            for (c in d)a[c] = d[c];
            for (var f = 0; f < Bd.length; f++)c = Bd[f], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c])
        }
    };
    function Dd() {
        this.wc = {}
    ...
    Gd.prototype.nf = function () {
        var a = this.Nd.get(), b = {}, c = !1, d;
        for (d in a)0 < a[d] && u(this.uf, d) && (b[d] = a[d], c = !0);
        c && (a = this.S, a.da && (b = {c: b}, a.f("reportStats", b), a.wa("s", b)));
    ...
    var Ld = null;
    "undefined" !== typeof MozWebSocket ? Ld = MozWebSocket : "undefined" !== typeof WebSocket && (Ld = WebSocket);
    function Md(a, b, c) {
        this.ie = a;
        this.f = pb(this.ie);
    ...
    var Nd;
    Md.prototype.open = function (a, b) {
        this.fb = b;
        this.bg = a;
        ...
        var e = this;
        this.na.onopen = function () {
            e.f("Websocket connected.");
            e.zc = !0
        };
        this.na.onclose = function () {
            e.f("Websocket connection was disconnected.");
            e.na = null;
            e.eb()
        };
        this.na.onmessage = function (a) {
            if (null !== e.na)if (a = a.data, e.kb +=
                    a.length, Ed(e.Pa, "bytes_received", a.length), Od(e), null !== e.frames)Pd(e, a); else {
                a:{
    ...
    Md.responsesRequiredToBeHealthy = 2;
    Md.healthyTimeout = 3E4;
    h = Md.prototype;
    h.wd = function () {
    ...
    h.send = function (a) {
        ...
        a = t(a);
        this.lb += a.length;
        Ed(this.Pa, "bytes_sent", a.length);
        a = zb(a, 16384);
        1 < a.length && this.na.send(String(a.length));
        for (var b = 0; b < a.length; b++)this.na.send(a[b])
    };
    h.Yc = function () {
        this.ub = !0;
    ...
    Vd.prototype.open = function (a, b) {
        ...
        ub(function () {
            if (!c.ub) {
                c.Ma = new Yd(function (a, b, d, k, l) {
                    Zd(c, arguments);
                    if (c.Ma)if (c.ob && (clearTimeout(c.ob), c.ob = null), c.zc = !0, "start" == a)c.id = b, c.mf = d; else if ("close" === a)b ? (c.Ma.Jd = !1, Rd(c.gf, b, function () {
                        c.eb()
    ...
    Vd.isAvailable = function () {
        return !Xd && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.yg) && (Wd || !0)
    };
    h = Vd.prototype;
    h.wd = function () {
    };
    ...
    h.eb = function () {
        this.ub || (this.f("Longpoll is closing itself"), this.Yc(), this.ga && (this.ga(this.zc), this.ga = null))
    };
    h.close = function () {
    ...
    h.send = function (a) {
        ...
        for (var b = 0; b < a.length; b++) {
            var c = this.Ma;
            c.Qc.push({ng: this.Ue, vg: a.length, We: a[b]});
            c.Zd && ae(c);
            this.Ue++
        }
    };
    ...
    function ae(a) {
        if (a.Zd && a.Jd && a.Fe.count() < (0 < a.Qc.length ? 2 : 1)) {
            ...
            for (var b = a.bd(b), c = "", d = 0; 0 < a.Qc.length;)if (1870 >= a.Qc[0].We.length + 30 + c.length) {
                var e = a.Qc.shift(), c = c + "&seg" + d + "=" + e.ng + "&ts" + d + "=" + e.vg + "&d" + d + "=" + e.We;
                d++
            } else break;
            be(a, b + c, a.ke);
            return !0
    ...
    function de(a, b) {
        var c = Md && Md.isAvailable(), d = c && !(Aa.ff || !0 === Aa.get("previous_websocket_failure"));
        b.xg && (c || z("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), d = !0);
        if (d)a.$c = [Md]; else {
            var e = a.$c = [];
            Ab(ee, function (a, b) {
    ...
    function je(a, b) {
        return function (c) {
            b === a.J ? (a.J = null, c || 0 !== a.Oa ? 1 === a.Oa && a.f("Realtime connection lost.") : (a.f("Realtime connection failed."), "s-" === a.Q.Ka.substr(0, 2) && (Aa.remove("host:" + a.Q.host), a.Q.Ka = a.Q.host)), a.close()) : b === a.C ? (a.f("Secondary connection lost."), c = a.C, a.C = null, a.ad !== c && a.Xc !== c || a.close()) : a.f("closing an old connection")
        }
    }
            ...
            if (2 != a.Oa)if (b === a.Xc) {
                ...
                if ("c" == d) {
                    if (d = xb("t", c), "d"in c)if (c = c.d, "h" === d) {
                        ...
                        a.Kd = c.s;
                        Da(a.Q, f);
                        0 == a.Oa && (a.J.start(), ke(a, a.J, d), "5" !== e && z("Protocol version mismatch detected"), c = a.xf, (c = 1 < c.$c.length ? c.$c[1] : null) && le(a, c))
                    } else if ("n" === d) {
                    ...
                    a.De && (a.De(c), a.De = null), a.ga = null, a.close()) : "r" === d ? (a.f("Reset packet received.  New host: " + c), Da(a.Q, c), 1 === a.Oa ? a.close() : (ne(a), he(a))) : "e" === d ? qb("Server Error: " + c) : "o" === d ? (a.f("got pong on primary."), oe(a), pe(a)) : qb("Unknown control packet command: " + d)
                } else"d" == d && a.Bd(c)
            } else if (b === a.C)if (d = xb("t", c), c = xb("d", c), "c" == d)"t"in c && (c = c.t, "a" === c ? qe(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.C.close(), a.ad !== a.C && a.Xc !== a.C || a.close()) : "o" === c && (a.f("got pong on secondary."),
                a.tf--, qe(a))); else if ("d" == d)a.Ed.push(c); else throw Error("Unknown protocol layer: " + d); else a.f("message on old connection")
        }
    }

    ge.prototype.wa = function (a) {
        re(this, {t: "d", d: a})
    };
    function me(a) {
    ...
    function qe(a) {
        0 >= a.tf ? (a.f("Secondary connection is healthy."), a.vb = !0, a.C.wd(), a.C.start(), a.f("sending client ack on secondary"), a.C.send({
            ...
            t: "c",
            d: {t: "n", d: {}}
        }), a.ad = a.C, me(a)) : (a.f("sending ping on secondary."), a.C.send({t: "c", d: {t: "p", d: {}}}))
    }

    ge.prototype.Bd = function (a) {
        oe(this);
        this.cc(a)
    };
    function oe(a) {
    ...
    function pe(a) {
        a.vb || 1 !== a.Oa || (a.f("sending ping on primary."), re(a, {t: "c", d: {t: "p", d: {}}}))
    }
    ...
    ge.prototype.close = function () {
        2 !== this.Oa && (this.f("Closing realtime connection."), this.Oa = 2, ne(this), this.ga && (this.ga(), this.ga = null))
    };
    function ne(a) {
    ...
    function se(a) {
        var b = {}, c = {}, d = {}, e = "";
        try {
            var f = a.split("."), b = ua(hb(f[0]) || ""), c = ua(hb(f[1]) || ""), e = f[2], d = c.d || {};
            delete c.d
        } catch (g) {
        }
        return {Ag: b, fe: c, data: d, rg: e}
    }
    ...
    function ue(a) {
        a = se(a);
        var b = a.fe;
        return !!a.rg && !!b && "object" === typeof b && b.hasOwnProperty("iat")
    };
    function ve(a, b, c, d) {
        this.id = we++;
        this.f = pb("p:" + this.id + ":");
        ...
        xe(this, 0);
        td.Qb().zb("visible", this.eg, this);
        -1 === a.host.indexOf("fblocal") && ud.Qb().zb("online", this.cg, this)
    }
    ...
    h.wa = function (a, b, c) {
        ...
        a = {r: d, a: a, b: b};
        this.f(t(a));
        x(this.da, "sendRequest call when we're not connected not allowed.");
        this.Ua.wa(a);
        c && (this.Tc[d] = c)
    };
    ...
    h.T = function (a, b, c) {
        ...
        Ce(this);
        (b = 40 == a.length) || (a = se(a).fe, b = "object" === typeof a && !0 === v(a, "admin"));
        b && (this.f("Admin auth credential detected.  Reducing max reconnect time."), this.xd = 3E4)
    };
    h.Pe = function (a) {
        delete this.Lb;
        this.da && this.wa("unauth", {}, function (b) {
            a(b.s, b.d)
        })
    };
    function Ce(a) {
        var b = a.Lb;
        a.da && b && a.wa("auth", {cred: b.Mf}, function (c) {
            var d = c.s;
            c = c.d || "error";
    ...
    function De(a, b, c, d) {
        a.da ? Ee(a, "o", b, c, d) : a.Jc.push({Pc: b, action: "o", data: c, H: d})
    }

    function Ge(a, b, c, d) {
        a.da ? Ee(a, "om", b, c, d) : a.Jc.push({Pc: b, action: "om", data: c, H: d})
    }

    h.Ce = function (a, b) {
        this.da ? Ee(this, "oc", a, null, b) : this.Jc.push({Pc: a, action: "oc", data: null, H: b})
    };
    ...
    function He(a, b, c, d, e, f) {
        d = {p: c, d: d};
        n(f) && (d.h = f);
        a.ka.push({action: b, of: d, H: e});
        a.Nc++;
        b = a.ka.length - 1;
        a.da ? Je(a, b) : a.f("Buffering put: " + c)
    }

    function Je(a, b) {
        var c = a.ka[b].action, d = a.ka[b].of, e = a.ka[b].H;
        a.ka[b].kg = a.da;
        a.wa(c, d, function (d) {
            a.f(c + " response", d);
            delete a.ka[b];
    ...
    h.Bd = function (a) {
        if ("r"in a) {
            ...
            "a"in a && (b = a.a, c = a.b, this.f("handleServerMessage", b, c), "d" === b ? this.Cd(c.p, c.d, !1, c.t) : "m" === b ? this.Cd(c.p, c.d, !0, c.t) : "c" === b ? Ke(this, c.p, c.q) : "ac" === b ? (a = c.s, b = c.d, c = this.Lb, delete this.Lb, c && c.cd && c.cd(a, b)) : "sd" === b ? this.Ke ? this.Ke(c) : "msg"in c && "undefined" !== typeof console && console.log("FIREBASE: " + c.msg.replace("\n",
    ...
    function xe(a, b) {
        x(!a.Ua, "Scheduling a connect when we're already connected/ing?");
    ...
    h.eg = function (a) {
        a && !this.qc && this.Va === this.xd && (this.f("Window became visible.  Reducing delay."), this.Va = 1E3, this.Ua || xe(this, 0));
        this.qc = a
    };
    h.cg = function (a) {
        a ? (this.f("Browser went online.  Reconnecting."), this.Va = 1E3, this.Eb = !0, this.Ua || xe(this, 0)) : (this.f("Browser went offline.  Killing connection; don't reconnect."), this.Eb = !1, this.Ua && this.Ua.close())
    };
    h.jf = function () {
        ...
        for (var a = 0; a < this.ka.length; a++) {
            var b = this.ka[a];
            b && "h"in b.of && b.kg && (b.H && b.H("disconnect"), delete this.ka[a], this.Nc--)
        }
        0 === this.Nc && (this.ka = []);
        if (this.Eb)this.qc ? this.Dc && (3E4 < (new Date).getTime() - this.Dc && (this.Va = 1E3), this.Dc = null) : (this.f("Window isn't visible.  Delaying reconnect."), this.Va = this.xd, this.ue = (new Date).getTime()), a = Math.max(0, this.Va - ((new Date).getTime() - this.ue)), a *= Math.random(), this.f("Trying to reconnect in " +
            a + "ms"), xe(this, a), this.Va = Math.min(this.xd, 1.3 * this.Va); else for (var c in this.Tc)delete this.Tc[c];
        this.Ad(!1)
    };
    function Me(a) {
        if (a.Eb) {
            ...
            a.Dc = null;
            var b = q(a.Bd, a), c = q(a.Kc, a), d = q(a.jf, a), e = a.id + ":" + ye++;
            a.Ua = new ge(e, a.Q, b, c, d, function (b) {
                z(b + " (" + a.Q.toString() + ")");
                a.Eb = !1
            })
        }
    ...
    h.tb = function () {
        this.Eb = !1;
        this.Ua ? this.Ua.close() : (this.Nb && (clearTimeout(this.Nb), this.Nb = null), this.da && this.jf())
    };
    h.kc = function () {
        this.Eb = !0;
        this.Va = 1E3;
    ...
    function Ke(a, b, c) {
        ...
        (a = Be(a, b, c)) && a.H && a.H("permission_denied")
    }
    ...
    function Le(a) {
        ...
        for (var b = 0; b < a.ka.length; b++)a.ka[b] && Je(a, b);
        for (; a.Jc.length;)b = a.Jc.shift(), Ee(a, b.action, b.Pc, b.data, b.H)
    };
    function Ne() {
        this.j = this.A = null
    }

    Ne.prototype.ic = function (a, b) {
        if (a.e())this.A = b, this.j = null; else if (null !== this.A)this.A = this.A.L(a, b); else {
            null == this.j && (this.j = new Td);
            var c = G(a);
            this.j.contains(c) || this.j.add(c, new Ne);
            c = this.j.get(c);
            a = R(a);
            c.ic(a, b)
        }
    ...
    function Oe(a, b) {
        ...
        return null !== a.j ? (c = G(b), b = R(b), a.j.contains(c) && Oe(a.j.get(c), b) && a.j.remove(c), a.j.e() ? (a.j = null, !0) : !1) : !0
    }

    function Pe(a, b, c) {
        null !== a.A ? c(b, a.A) : a.fa(function (a, e) {
    ...
    Ne.prototype.fa = function (a) {
        null !== this.j && Ud(this.j, function (b, c) {
            a(b, c)
        })
    };
    function Qe() {
    ...
    function Se(a, b) {
        for (var c = null, d = 0; d < b.length; d++) {
            var e = b[d], f = e.Rb();
            null === c || f.ea(c.Rb()) || (a.qb.push(c), c = null);
            null === c && (c = new Te(f));
            c.add(e)
        }
        c && a.qb.push(c)
    ...
    var Ye = ["remember", "redirectTo"];

    function Ze(a) {
        var b = {}, c = {};
        va(a || {}, function (a, e) {
            0 <= Ia(Ye, a) ? b[a] = e : c[a] = e
        });
        return new Xe(b, {}, c)
    };
    var $e = {
    ...
    kf.prototype.open = function (a, b, c) {
        ...
        e.onreadystatechange = function () {
            if (c && 4 === e.readyState) {
                ...
                c = null;
                cf(window, "beforeunload", d)
            }
        };
        if ("GET" === f)a += (/\?/.test(a) ? "" : "?") + ff(b), g = null; else {
            var k = this.options.headers.content_type;
            "application/json" === k && (g = t(b));
            "application/x-www-form-urlencoded" === k && (g = ff(b))
        }
        e.open(f, a, !0);
        a = {"X-Requested-With": "XMLHttpRequest", Accept: "application/json;text/plain"};
        Cd(a, this.options.headers);
        for (var l in a)e.setRequestHeader(l, a[l]);
        e.send(g)
    };
    kf.isAvailable = function () {
        return !!window.XMLHttpRequest && "string" === typeof(new XMLHttpRequest).responseType && (!(navigator.userAgent.match(/MSIE/) || navigator.userAgent.match(/Trident/)) || jf())
    };
    kf.prototype.uc = function () {
        return "json"
    };
    function lf(a) {
        a = a || {};
    ...
    lf.prototype.open = function (a, b, c) {
        function d() {
            c && (c(V("USER_CANCELLED")), c = null)
        }

        var e = this, f = sb(We), g;
        b.requestId = this.Uc;
        ...
        (g = window.open(a, "_blank", "location=no")) && ha(g.addEventListener) ? (g.addEventListener("loadstart", function (a) {
            ...
            if (b = a && a.url)a:{
                ...
                try {
                    ...
                    r.href = f;
                    b = r.host === sb(We).host && "/blank/page.html" === r.pathname;
                    break a
                } catch (s) {
                }
                b = !1
            }
            b && (a = ef(a.url), g.removeEventListener("exit",
                d), g.close(), a = new Xe(null, null, {
                requestId: e.Uc,
                requestKey: a
            }), e.kf.requestWithCredential("/auth/session", a, c), c = null)
        }), g.addEventListener("exit", d)) : c(V("TRANSPORT_UNAVAILABLE"))
    };
    lf.isAvailable = function () {
        return hf()
    };
    ...
    function mf(a) {
        ...
        a.relay_url || (a.relay_url = gf() + "/auth/channel");
        this.options = a
    }
    ...
    mf.prototype.open = function (a, b, c) {
        ...
        var f = jf(), g, k, l = df(a);
        if (l !== df(this.options.relay_url))c && setTimeout(function () {
    ...
    nf.prototype.open = function (a, b, c) {
        ...
        function e() {
            setTimeout(function () {
                ...
                zd(window.__firebase_auth_jsonp) && delete window.__firebase_auth_jsonp;
                try {
    ...
    pf.prototype.get = function () {
        var a = La(this.Pd, q(this.Sf, this)), a = Ka(a, function (a) {
            return null !== a
        });
        Ta(a, function (a, c) {
            return te(c.token) - te(a.token)
        });
        return 0 < a.length ? a.shift() : null
    };
    pf.prototype.Sf = function (a) {
        try {
            var b = a.get(this.Ge);
    ...
    qf.prototype.open = function (a, b) {
    ...
    qf.isAvailable = function () {
        return !/^file:\//.test(location.href) && !hf()
    };
    qf.prototype.uc = function () {
        return "redirect"
    };
    function rf(a, b, c, d) {
        rd.call(this, ["auth_status"]);
        this.Q = a;
        this.Re = b;
        this.wg = c;
        this.Be = d;
        this.mc = new pf(a, [Aa, Ba]);
        this.jb = null;
        sf(this)
    }
    ...
    function sf(a) {
        Ba.get("redirect_request_id") && tf(a);
        var b = a.mc.get();
        b && b.token ? (uf(a, b), a.Re(b.token, function (c, d) {
            vf(a, c, d, !1, b.token, b)
        }, function (b, d) {
            wf(a, "resumeSession()", b, d)
        })) : uf(a, null)
    }

    function xf(a, b, c, d, e, f) {
        "firebaseio-demo.com" === a.Q.domain && z("FirebaseRef.auth() not supported on demo Firebases (*.firebaseio-demo.com). Please use on production Firebases only (*.firebaseio.com).");
        a.Re(b, function (f, k) {
            vf(a, f, k, !0, b, c, d || {}, e)
        }, function (b, c) {
            wf(a, "auth()", b, c, f)
    ...
    function vf(a, b, c, d, e, f, g, k) {
        "ok" === b ? (d && (b = c.auth, f.auth = b, f.expires = c.expires, f.token = ue(e) ? e : "", c = null, b && u(b, "uid") ? c = v(b, "uid") : u(f, "uid") && (c = v(f, "uid")), f.uid = c, c = "custom", b && u(b, "provider") ? c = v(b, "provider") : u(f, "provider") && (c = v(f, "provider")), f.provider = c, a.mc.clear(), ue(e) && (g = g || {}, c = Aa, "sessionOnly" === g.remember && (c = Ba), "none" !== g.remember && a.mc.set(f, c)), uf(a, f)), B(k, null, f)) : (a.mc.clear(), uf(a, null), f = a = (b || "error").toUpperCase(), c && (f += ": " + c), f = Error(f), f.code = a, B(k, f))
    }
    ...
    function tf(a) {
        ...
        if (b) {
            ...
            var d = [kf, nf], b = {requestId: b, requestKey: ef(document.location.hash)}, c = new Xe(c, {}, b);
            try {
                document.location.hash = document.location.hash.replace(/&__firebase_request_key=([a-zA-z0-9]*)/, "")
            } catch (e) {
            }
            Bf(a, d, "/auth/session", c)
        }
    }
    ...
    h.Ie = function (a, b) {
        var c = this;
        Af(this);
        var d = "/users/" + encodeURIComponent(a.email), e = Ze(a);
        e.lc._method = "DELETE";
        this.Vc(d, e, function (a, d) {
            !a && d && d.uid && c.jb && c.jb.uid && c.jb.uid === d.uid && yf(c);
            B(b, a)
        })
    };
    h.ee = function (a, b) {
        Af(this);
        var c = "/users/" + encodeURIComponent(a.email) + "/password", d = Ze(a);
        d.lc._method = "PUT";
    ...
    function Bf(a, b, c, d, e) {
        Df(a, b, c, d, function (b, c) {
            !b && c && c.token && c.uid ? xf(a, c.token, c, d.ed, function (a, b) {
                a ? B(e, a) : B(e, null, b)
    ...
    function Df(a, b, c, d, e) {
        ...
        }, 0) : (b = new (b.shift())(d.Sd), d = wa(d.lc), d.v = "js-2.0.2", d.transport = b.uc(), d.suppress_status_codes = !0, a = gf() + "/" + a.Q.yb + c, b.open(a, d, function (a, b) {
    ...
    function Af(a) {
        var b = a.Q;
        if ("firebaseio.com" !== b.domain && "firebaseio-demo.com" !== b.domain && "auth.firebase.com" === We)throw Error("This custom Firebase server ('" + a.Q.domain + "') does not support delegated login.");
    };
    function Ef(a, b) {
    ...
    function Gf(a, b) {
        var c = a.O().N(), c = Ef(c, b), d;
        if (a.P()) {
            var e = Ef(a.ta(), b);
            return e !== a.ta() || c !== a.O().N() ? new Xc(e, J(c)) : a
        }
        d = a;
        c !== a.O().N() && (d = d.ib(new Xc(c)));
        a.fa(L, function (a, c) {
            var e = Gf(c, b);
            e !== c && (d = d.I(a, e))
        });
    ...
    function Jf(a, b, c, d) {
        ...
        f = X(c);
        e = X(b);
        if (d.e())return c.o ? (a = [], e ? e.ea(f) || (e.P() ? a = Kf(f) : f.P() ? (a = [], e.P() || e.e() || a.push(new W("children_removed", e))) : a = Lf(e, f), a.push(new W("value", f))) : (a = Kf(f), a.push(new W("value", f))), 0 !== a.length || b.o || a.push(new W("value", f)), a) : e ? Lf(e, f) : Kf(f);
        if (".priority" === G(d))return !c.o || e && e.ea(f) ? [] : [new W("value", f)];
        if (c.o || 1 === Q(d))return e = G(d), f = f.B(e), a.kd(b, c, e, f);
        e = G(d);
        return f.Y(e) ? (f = f.B(e), a.kd(b, c, e, f)) : []
    }

    Hf.prototype.kd = function (a, b, c, d) {
        (a = X(a)) ? a.Y(c) ? (a = a.B(c), c = a.ea(d) ? [] : d.e() ? [new W("child_removed", a, c)] : [new W("child_changed", d, c, a)]) : c = d.e() ? [] : [new W("child_added", d, c)] : c = d.e() ? [] : [new W("child_added", d, c)];
        0 < c.length && b.o && c.push(new W("value", X(b)));
        return c
    };
    function Kf(a) {
        var b = [];
    ...
    Mf.prototype.kd = function (a, b, c, d) {
        var e = X(a) || K, f = X(b) || K;
        if (e.Ta() < this.bb || f.Ta() < this.bb)return Mf.oc.kd.call(this, a, b, c, d);
        x(!e.P() && !f.P(), "If it's a leaf node, we should have hit the above case.");
        a = [];
        var g = e.B(c);
        g.e() ? f.Y(c) && (e = this.La ? jd(e, this.w) : kd(e, this.w), a.push(new W("child_removed", e.K, e.name)), a.push(new W("child_added", d, c))) : f.Y(c) ? d.ea(g) || a.push(new W("child_changed", d, c, e.B(c))) : (a.push(new W("child_removed", g, c)), e = this.La ? jd(f, this.w) : kd(f, this.w), a.push(new W("child_added",
            e.K, e.name)));
        0 < a.length && b.o && a.push(new W("value", f));
        return a
    };
    function Nf() {
    }
    ...
    h.Xa = function (a, b, c, d) {
        var e;
        if (b.type === Of) {
            if (b.source.$e)return this.Fa(a, b.path, b.Na, c, d);
            x(b.source.Ze, "Unknown source.");
            e = b.source.wf;
            return this.Ra(a, b.path, b.Na, c, d, e)
        }
        if (b.type === Pf) {
        ...
        if (b.type === Qf) {
            if (b.sf)a:{
                ...
                e = a.X;
                if (a.D) {
                    x(a.o, "Must have event snap if we have server snap");
                    var g = c.Ya(f, a.o, a.D);
                    if (g)if (b = a.o.L(f,
                            g), f.e())b = this.F(b); else {
                        e = G(f);
                        b = b.B(e);
                        a = this.Qa(a, e, b, a.D, a.n, c, d);
                        break a
                    }
                } else if (a.n)if (a.o)(d = c.Ob()) ? b = this.F(d) : (c = c.Ya(f, a.o, a.n)) && (b = this.F(b.L(f, c))); else {
                    if (x(a.X, "We must at least have complete children"), x(!f.e(), "If the path were empty, we would have an event snap from the set"), c = c.Ya(f, a.X, a.n))e = a.X.L(f, c), e = this.F(e)
                } else if (a.o)(c = c.Ob()) && (b = this.F(c)); else if (a.X) {
                    x(!f.e(), "If the path was empty, we would have an event snap");
                    g = G(f);
                    if (a.X.Y(g)) {
                        a = (b = c.Ib.Ob(c.Gb.k(g))) ? this.Qa(a,
                            g, b, a.D, a.n, c, d) : this.Qa(a, g, K, a.D, a.n, c, null);
                        break a
                    }
                    x(1 < Q(f), "Must be a deep set being reverted")
                }
                a = new Sf(a.D, a.n, b, e)
            } else a = this.Ea(a, b.path, c, d);
            return a
        }
        if (b.type === Tf)return b = b.path, Rf(this, a), this.Ra(a, b, (a.ab() || K).$(b), c, d, !1);
        throw gb("Unknown operation type: " + b.type);
    };
    function Rf(a, b) {
        Uf(a, b.D);
        Uf(a, b.n);
    ...
    h.Fa = function (a, b, c, d, e) {
        Rf(this, a);
        if (b.e())return b = this.F(c), new Sf(a.D, a.n, b, null);
        var f = X(a) || K, g = G(b);
        return 1 === Q(b) || a.o || f.Y(g) ? (c = f.B(G(b)).L(R(b), c), this.Qa(a, G(b), c, a.D, a.n, d, e)) : a
    };
    ...
    h.Ea = function (a, b, c, d) {
        ...
        if (a.D) {
            ...
            var k = c.Ya(b, a.o, a.D);
            if (k)if (b.e())e = this.F(k); else return g = G(b), b = e.L(b, k).B(g), this.Qa(a, g, b, a.D, a.n, c, d)
        } else if (a.n)if (e) {
            var l = !1;
            a.n.fa(L, function (a, b) {
                l || e.B(a).ea(b) || (l = !0);
                l && (e = e.I(a, b))
            });
            l && (e = this.F(e))
        } else if (f && (x(0 < Q(b), "If it were an empty path, we would have an event snap"), g = G(b), 1 === Q(b) || f.Y(g)) && (k = c.Ya(b, f, a.n)))return b = f.L(b, k).B(g), this.Qa(a, g, b, a.D,
            a.n, c, d);
        return new Sf(a.D, a.n, e, f)
    };
    h.Ra = function (a, b, c, d, e, f) {
        var g;
        Rf(this, a);
        var k = a.D, l = a.n;
        if (a.D)k = b.e() ? this.F(c, f) : this.F(a.D.L(b, c), f); else if (b.e())k = this.F(c, f), l = null; else if (1 === Q(b) && (a.n || !c.e()))l = a.n || this.Ia(K), l = this.F(l.L(b, c), f); else if (a.n && (g = G(b), a.n.Y(g)))var m = a.n.B(g).L(R(b), c), l = this.F(a.n.I(g, m), f);
        g = !1;
        f = a.o;
        m = a.X;
        if (k !== a.D || l !== a.n)if (k && !f)f = this.F(d.xa(k)), m = null; else if (k && f && !c.e() && k.$(b).ea(f.$(b)))g = !0; else if (c = d.Ya(b, f, k || l))if (b.e())f = this.F(c), m = null; else {
            g = G(b);
            b = R(b);
            a:{
                f = g;
                if (a.o)m = a.o.B(f);
                    ...
                    x(a.D || a.n, "If we do not have event data, we must have server data");
                    m = (a.D || a.n).B(f)
                }
                m = m.e() && a.ab() ? a.ab().B(f).L(b, c) : m.L(b, c)
            }
            return this.Qa(a, g, m, k, l, d, e)
        } else g = !0;
        x(!g || f === a.o && m === a.X, "We thought we could skip diffing, but we changed the eventCache.");
        return new Sf(k, l, f, m)
    };
    h.$d = function (a, b, c, d, e, f) {
        if (!a.D && !a.n && b.e())return a;
        Rf(this, a);
        var g = this, k = a;
        va(c, function (c, m) {
            var r = b.k(c);
            Vf(a, G(r)) && (k = g.Ra(k, r, m, d, e, f))
        });
        va(c, function (c, m) {
            var r = b.k(c);
            Vf(a, G(r)) || (k = g.Ra(k, r, m, d, e, f))
    ...
    h.Qa = function (a, b, c, d, e) {
        var f = a.o;
        a = a.X;
        f ? f = this.F(f.I(b, c)) : (a || (a = this.Ia(K)), a = this.F(a.I(b, c)));
        return new Sf(d, e, f, a)
    };
    h.F = function (a) {
        return this.Ia(a)
    };
    ...
    function Wf(a) {
        this.gb = a;
        this.index = a.w;
        this.gb.la && n(nc(this.gb)) ? (a = oc(this.gb), a = this.index.ye(nc(this.gb), a)) : a = this.index.Ae();
        this.Fb = a;
        this.gb.sa && n(pc(this.gb)) ? (a = qc(this.gb), a = this.index.ye(pc(this.gb), a)) : a = this.index.ze();
        this.pb = a
    }

    na(Wf, Nf);
    Wf.prototype.Ia = function (a) {
        return a.Wd(this.index)
    };
    Wf.prototype.Yb = function (a) {
        return a.Yb(this.index)
    };
    Wf.prototype.F = function (a, b) {
        if (!1 === b)return Wf.oc.F.call(this, a, !1);
    ...
    Wf.prototype.Fa = function (a, b, c, d, e) {
        Rf(this, a);
        if (1 < Q(b)) {
            var f = G(b);
            if ((null !== X(a) ? X(a) : K).Y(f))return Wf.oc.Fa.call(this, a, b, c, d, e);
            var g = null !== e ? e : a.ab(), g = null !== g && g.Y(f) ? g.B(f) : null, g = d.k(f).xa(g);
            return null !== g ? (b = g.L(R(b), c), this.Qa(a, f, b, a.D, a.n, d, e)) : a
        }
        return Wf.oc.Fa.call(this, a, b, c, d, e)
    };
    function Xf(a) {
        Wf.call(this, a);
        this.La = !("" === a.Hb ? a.la : "l" === a.Hb);
        this.bb = rc(a)
    }

    na(Xf, Wf);
    Xf.prototype.F = function (a, b) {
        if (!1 === b)return Xf.oc.F.call(this, a, !1);
        if (a.P())return this.Ia(K);
        var c = this.Ia(a), d, e, f, g;
        if (2 * this.bb < a.Ta())for (d = this.Ia(K.ib(a.O())), c = this.La ? c.Sb(this.pb, this.index) : c.rb(this.Fb, this.index), e = U(c), f = 0; e && f < this.bb;)if (g = this.La ? 0 >= H(this.index)(this.Fb, e) : 0 >= H(this.index)(e, this.pb))d = d.I(e.name, e.K), f++, e = U(c); else break; else {
            d = this.Ia(a);
    ...
    Xf.prototype.Qa = function (a, b, c, d, e, f, g) {
        var k = X(a);
        return !k || k.Ta() < this.bb ? Xf.oc.Qa.call(this, a, b, c, d, e, f, g) : (b = Yf(this, a, b, c, f, g || d)) ? a.o ? new Sf(d, e, b, null) : new Sf(d, e, null, b) : new Sf(d, e, a.o, a.X)
    };
    ...
    function ag(a, b, c, d) {
        var e = [], f = a.w, g = La(Ka(b, function (a) {
            return "child_changed" === a.type && f.df(a.Zf, a.Wa)
        }), function (a) {
        ...
        for (la(Ra, b, k, 0).apply(null, g); 0 < b.length;) {
            var g = b[0].type, k = bg(b, g), l = b.slice(0, k);
            b = b.slice(k);
        ...
        for (var e = [], f = 0; f < c.length; ++f)for (var g = c[f], k = null, l = null, m = 0; m < b.length; ++m) {
            ...
            if (r.pf(g.type)) {
                if (!k && !l)if ("children_added" === g.type) {
                    var s = a, y = g.Wa, l = [];
                    if (!y.P() && !y.e())for (var s = y.Aa(s.w), y = null, N = U(s); N;) {
                        var Fe = new W("child_added", N.K, N.name);
                        Fe.Rc = y;
                        l.push(Fe);
                        y = N.name;
                        N = U(s)
                    ...
                    if (s = a, y = g.Wa, l = [], !y.P() && !y.e())for (s = y.Aa(s.w), y = U(s); y;)l.push(new W("child_removed", y.K, y.name)), y = U(s)
                } else k = g, "value" !== k.type && "child_removed" !==
                k.type && (k.Rc = d.af(k.nb, k.Wa, a.w));
    ...
    $f.prototype.Lf = function (a, b) {
        if (null == a.nb || null == b.nb)throw gb("Should only compare child_ events.");
        return this.w.compare(new I(a.nb, a.Wa), new I(b.nb, b.Wa))
    };
    function dg(a, b) {
        this.U = a;
        var c = a.u;
        uc(c) ? (this.ec = new Zf(c.w), this.ld = If) : c.ja ? (this.ec = new Xf(c), this.ld = new Mf(rc(c), c.w, this.ec.La)) : (this.ec = new Wf(c), this.ld = If);
        c = this.ec;
        this.ia = new Sf(b.D && c.F(b.D, !1), b.n && c.F(b.n, !1), b.o && c.F(b.o), b.X && c.F(b.X));
        this.ya = [];
        this.le = new $f(a)
    }
    ...
    h.za = function (a) {
        var b = this.ia.za();
        return b && (uc(this.U.u) || !a.e() && !b.B(G(a)).e()) ? b.$(a) : null
    };
    h.e = function () {
    ...
    h.Xa = function (a, b, c) {
        a.type === Pf && null !== a.source.fc && (x(this.ia.za(), "We should always have a full cache before handling merges"), x(!!this.ia.o, "Missing event cache, even though we have a server cache"));
        var d = this.ia;
        b = this.ec.Xa(d, a, b, c);
        Rf(this.ec, b);
        this.ia = b;
        return X(b) !== X(d) ? (a = Jf(this.ld, d, b, a.path), d = X(b), ag(this.le, a, d, this.ya)) : b.o && !d.o ? (x(X(b) === X(d), "Caches should be the same."), d = X(b), ag(this.le, [new W("value", d)], d, this.ya)) : []
    };
    function Sf(a, b, c, d) {
        this.D = a;
        this.n = b;
    ...
    Sf.prototype.za = function () {
        return this.D
    };
    var fg = new Sf(null, null, null, null);
    ...
    function jg(a, b, c) {
        ...
        var d = G(b);
        a = a.children.get(d);
        return null !== a ? (b = jg(a, R(b), c), null != b ? {path: (new P(d)).k(b.path), value: b.value} : null) : null
    }

    function kg(a, b) {
        return jg(a, b, function () {
            return !0
        })
    }
    ...
    h.subtree = function (a) {
        ...
        return null !== b ? b.subtree(R(a)) : ig
    };
    h.set = function (a, b) {
        if (a.e())return new gg(b, this.children);
        var c = G(a), d = (this.children.get(c) || ig).set(R(a), b), c = this.children.Ja(c, d);
        return new gg(this.value, c)
    };
    h.remove = function (a) {
        if (a.e())return this.children.e() ? ig : new gg(null, this.children);
        var b = G(a), c = this.children.get(b);
        return c ? (a = c.remove(R(a)), b = a.e() ? this.children.remove(b) : this.children.Ja(b, a), null === this.value && b.e() ? ig : new gg(this.value, b)) : this
    };
    h.get = function (a) {
    ...
    function lg(a, b, c) {
        if (b.e())return c;
        var d = G(b);
        b = lg(a.children.get(d) || ig, R(b), c);
        d = b.e() ? a.children.remove(d) : a.children.Ja(d, b);
        return new gg(a.value, d)
    }
    ...
    function pg(a, b, c, d) {
        ...
        if (b.e())return null;
        e = G(b);
        return (a = a.children.get(e)) ? pg(a, R(b), c.k(e), d) : null
    }
    ...
    function qg(a, b, c) {
        if (!b.e()) {
            ...
            !0 === d && (d = G(b), (a = a.children.get(d)) && rg(a, R(b), S.k(d), c))
        }
    }
    ...
    function rg(a, b, c, d) {
        ...
        a.value && d(c, a.value);
        var e = G(b);
        return (a = a.children.get(e)) ? rg(a, R(b), c.k(e), d) : ig
    }
    ...
    h.Xa = function (a, b, c) {
        var d = a.source.fc;
        if (null !== d)return d = v(this.pa, d), x(null != d, "SyncTree gave us an op for an invalid query."), d.Xa(a, b, c);
        var e = [];
        A(this.pa, function (d) {
            e = e.concat(d.Xa(a, b, c))
        });
        return e
    };
    h.Jb = function (a, b, c, d, e) {
        var f = a.Da(), g = v(this.pa, f);
        g || (c = (g = c.xa(d)) ? null : c.ce(e), d = new Sf(d, e, g, c), g = new dg(a, d), this.pa[f] = g);
        g.Jb(b);
        a = g;
        (f = X(a.ia)) ? (d = Jf(a.ld, fg, a.ia, S), b = ag(a.le, d, f, b ? [b] : a.ya)) : b = [];
        return b
    };
    h.hb = function (a, b, c) {
        var d = a.Da(), e = [], f = [], g = null != wg(this);
        if ("default" === d) {
            var k = this;
            A(this.pa, function (a, d) {
                f = f.concat(a.hb(b, c));
                a.e() && (delete k.pa[d], uc(a.U.u) || e.push(a.U))
            })
        } else {
            var l = v(this.pa, d);
            l && (f = f.concat(l.hb(b, c)), l.e() && (delete this.pa[d], uc(l.U.u) || e.push(l.U)))
        }
        g && null == wg(this) && e.push(new O(a.g, a.path));
        return {lg: e, Pf: f}
    };
    function xg(a) {
        return Ka(vd(a.pa), function (a) {
            return !uc(a.U.u)
        })
    }
    ...
    h.za = function (a) {
        var b = null;
        A(this.pa, function (c) {
            b = b || c.za(a)
        });
        return b
    };
    function yg(a, b) {
        if (uc(b.u))return wg(a);
        var c = b.Da();
        return v(a.pa, c)
    }

    function wg(a) {
        return yd(a.pa, function (a) {
                return uc(a.U.u)
            }) || null
    };
    function zg() {
    ...
    function Ag(a, b) {
        var c = Pa(a.qa, function (a) {
            return a.Xd === b
        });
        x(0 <= c, "removeWrite called with nonexistent writeId.");
        var d = a.qa[c];
        a.qa.splice(c, 1);
        for (var e = !1, f = !1, g = !1, k = a.qa.length - 1; !e && 0 <= k;) {
            var l = a.qa[k];
            k >= c && Bg(l, d.path) ? e = !0 : !f && d.path.contains(l.path) && (k >= c ? f = !0 : g = !0);
            k--
        }
        e || (f || g ? Cg(a) : d.Na ? a.V = a.V.remove(d.path) : A(d.children, function (b, c) {
    ...
    h.xa = function (a, b, c, d) {
        var e, f;
        if (c || d)return e = this.V.subtree(a), !d && e.e() ? b : d || null !== b || null !== e.value ? (e = Dg(this.qa, function (b) {
            return (b.visible || d) && (!c || !(0 <= Ia(c, b.Xd))) && (b.path.contains(a) || a.contains(b.path))
        }, a), f = b || K, sg(e, function (a, b) {
            f = f.L(a, b)
        }), f) : null;
        if (e = kg(this.V, a))return b = T(e.path, a), e.value.$(b);
        e = this.V.subtree(a);
        return e.e() ? b : b || e.value ? (f = b || K, sg(e, function (a, b) {
            f = f.L(a, b)
        }), f) : null
    };
    h.ce = function (a, b) {
        var c = !1, d = K, e = this.Ob(a);
        if (e)return e.P() || e.fa(L, function (a, b) {
            d = d.I(a, b)
        }), d;
        if (b)return d = b, ug(this.V.subtree(a), function (a, b) {
            d = d.I(a, b)
        }), d;
        ug(this.V.subtree(a), function (a, b) {
            c = !0;
            d = d.I(a, b)
        });
        return c ? d : null
    ...
    h.Ya = function (a, b, c, d) {
        ...
        a = a.k(b);
        if (kg(this.V, a))return null;
        a = this.V.subtree(a);
        if (a.e())return d.$(b);
        var e;
        c ? (e = !1, sg(a, function (a, b) {
            e || c.$(a).ea(b) || (e = !0)
        })) : e = !0;
        if (e) {
            var f = d.$(b);
    ...
    h.de = function (a, b, c, d, e, f) {
        var g;
        a = this.V.subtree(a);
        a.value ? g = a.value : b && (g = b, sg(a, function (a, b) {
            g = g.L(a, b)
        }));
        if (g) {
            b = [];
    ...
    function Bg(a, b) {
        return a.Na ? a.path.contains(b) : !!xd(a.children, function (c, d) {
    ...
    function Cg(a) {
        a.V = Dg(a.qa, Eg, S);
        a.Ec = 0 < a.qa.length ? a.qa[a.qa.length - 1].Xd : -1
    }
    ...
    function Dg(a, b, c) {
        for (var d = ig, e = 0; e < a.length; ++e) {
            var f = a[e];
            if (b(f)) {
                var g = f.path, k;
                f.Na ? (c.contains(g) ? (k = T(c, g), f = f.Na) : (k = S, f = f.Na.$(T(g, c))), d = Fg(d, k, f)) : d = Gg(d, f.path, f.children)
            }
        }
        return d
    }
    ...
    h.k = function (a) {
        return new Hg(this.Gb.k(a), this.Ib)
    };
    function Ig(a, b, c) {
        this.type = Of;
        this.source = a;
    ...
    Ig.prototype.Mc = function (a) {
        return this.path.e() ? new Ig(this.source, S, this.Na.B(a)) : new Ig(this.source, R(this.path), this.Na)
    };
    function Jg(a, b) {
        this.type = Qf;
        this.source = Kg;
    ...
    Jg.prototype.Mc = function () {
        return this.path.e() ? this : new Jg(R(this.path), this.sf)
    };
    function Lg(a, b) {
        this.type = Tf;
        this.source = a;
    ...
    Lg.prototype.Mc = function () {
        return this.path.e() ? new Lg(this.source, S) : new Lg(this.source, R(this.path))
    };
    function Mg(a, b, c) {
        this.type = Pf;
        this.source = a;
    ...
    Mg.prototype.Mc = function (a) {
        return this.path.e() ? (a = v(this.children, a)) ? new Ig(this.source, S, a) : null : new Mg(this.source, R(this.path), this.children)
    };
    var Of = 0, Pf = 1, Qf = 2, Tf = 3;
    ...
    var Kg = new Ng(!0, !1, null, !1), Og = new Ng(!1, !0, null, !1);
    ...
    h.Fa = function (a, b, c, d) {
        ...
        n(f) || (f = !0);
        e.qa.push({path: a, Na: b, Xd: c, visible: f});
        f && (e.V = Fg(e.V, a, b));
        e.Ec = c;
        return d ? Qg(this, new Ig(Kg, a, b)) : []
    };
    h.ae = function (a, b, c) {
        var d = this.Bb;
        x(c > d.Ec, "Stacking an older merge on top of newer ones");
        d.qa.push({path: a, children: b, Xd: c, visible: !0});
        d.V = Gg(d.V, a, b);
        d.Ec = c;
    ...
    h.Ea = function (a, b) {
        b = b || !1;
        var c = Ag(this.Bb, a);
        return null == c ? [] : Qg(this, new Jg(c, b))
    };
    h.Ra = function (a, b) {
        return Qg(this, new Ig(Og, a, b))
    };
    h.$d = function (a, b) {
        return Qg(this, new Mg(Og, a, b))
    };
    function Rg(a, b, c, d) {
        d = Ad(a.Zc, "_" + d);
        if (null != d) {
    ...
    h.Jb = function (a, b) {
        ...
        var f = this.ma.get(c);
        f ? (e = e || null != wg(f), d = d || f.za(S)) : (f = new vg, this.ma = this.ma.set(c, f));
        var g = null;
        if (!d) {
            var k = !1, g = K;
            ug(this.ma.subtree(c), function (a, b) {
                var c = b.za(S);
                c && (k = !0, g = g.I(a, c))
            });
            k || (g = null)
        ...
        m = f.Jb(a, b, new Hg(c, this.Bb),
            d, g);
        l || e || (f = yg(f, a), m = m.concat(Xg(this, a, f)));
        return m
    };
    h.hb = function (a, b, c) {
        var d = a.path, e = this.ma.get(d), f = [];
        if (e && ("default" === a.Da() || null != yg(e, a))) {
            f = e.hb(a, b, c);
            ...
            var g = og(this.ma, d, function (a, b) {
                return null != wg(b)
            });
            if (b && !g && (d = this.ma.subtree(d), !d.e()))for (var d = Yg(d), k = 0; k < d.length; ++k) {
                var l = d[k], m = l.U, l = Zg(this, l);
                this.Fc.Le(m, $g(this, m), l.qd, l.H)
            }
    ...
    h.xa = function (a, b) {
        var c = this.Bb, d = og(this.ma, a, function (b, c) {
            var d = T(b, a);
    ...
    function Yg(a) {
        return mg(a, function (a, c, d) {
            if (c && null != wg(c))return [wg(c)];
            var e = [];
            c && (e = xg(c));
            A(d, function (a) {
                e = e.concat(a)
    ...
    function Xg(a, b, c) {
        var d = b.path, e = $g(a, b);
        c = Zg(a, c);
        b = a.Fc.Le(b, e, c.qd, c.H);
        d = a.ma.subtree(d);
        if (e)x(null == wg(d.value), "If we're adding a query, it shouldn't be shadowed"); else for (e = mg(d, function (a, b, c) {
            if (!a.e() && b && null != wg(b))return [eg(wg(b))];
            var d = [];
            b && (d = d.concat(La(xg(b), function (a) {
                return a.U
            })));
            A(c, function (a) {
                d = d.concat(a)
            ...
            return d
        }), d = 0; d < e.length; ++d)c = e[d], a.Fc.Od(c, $g(a, c));
        return b
    }
            ...
            qd: function () {
                ...
                if ("ok" === b) {
                    if (f && "object" === typeof f && u(f, "w")) {
                        var g = v(f, "w");
                        ea(g) && 0 <= Ia(g, "no_index") && z("Using an unspecified index. Consider adding " + ('".indexOn": "' + c.u.w.toString() + '"') + " at " + c.path.toString() + " to your security rules for better performance")
                    }
                    if (d) {
                        var k = c.path;
                        if (g = Ad(a.Zc, "_" + d))var l = Sg(g), g = l.path, l = l.fc, k = T(g, k), k = new Lg(new Ng(!1, !0, l, !0), k), g = Tg(a, g, k); else g = []
                    } else g = Qg(a, new Lg(Og,
                        c.path));
                    return g
                }
                g = "Unknown Error";
    ...
    function Tg(a, b, c) {
        ...
        return d.Xa(c, new Hg(b, a.Bb), null)
    }

    function Qg(a, b) {
        return bh(a, b, a.ma, null, new Hg(S, a.Bb))
    }

    function bh(a, b, c, d, e) {
        if (b.path.e())return ch(a, b, c, d, e);
        var f = c.get(S);
        null == d && null != f && (d = f.za(S));
        var g = [], k = G(b.path), l = b.Mc(k);
        if ((c = c.children.get(k)) && l)var m = d ? d.B(k) : null, k = e.k(k), g = g.concat(bh(a, l, c, m, k));
    ...
    function dh(a) {
        ...
        this.Z = new Re;
        this.zd = 1;
        this.S = new ve(this.Q, q(this.Cd, this), q(this.Ad, this), q(this.Ee, this));
        this.tg = Kd(a, q(function () {
            return new Gd(this.Pa, this.S)
        }, this));
        this.pc = new Dc;
        this.qe = new Qe;
        var b = this;
        this.ud = new Pg({
            Le: function (a, d, e, f) {
                d = [];
                e = b.qe.Wc.$(a.path);
                e.e() || (d = b.ud.Ra(a.path, e), setTimeout(function () {
                    f("ok")
                }, 0));
                return d
            }, Od: ba
        ...
        eh(this, "connected", !1);
        this.ga = new Ne;
        this.T = new rf(a, q(this.S.T, this.S), q(this.S.Pe, this.S), q(this.Be, this));
        this.jd = 0;
        this.re = null;
        this.M = new Pg({
            Le: function (a, d, e, f) {
                ze(b.S, a, e, d, function (d, e) {
                    var l = f(d, e);
                    Ve(b.Z, a.path, l)
                });
                return []
    ...
    h.Cd = function (a, b, c, d) {
        ...
        a = [];
        d ? c ? (b = dd(b, function (a) {
            return J(a)
        }), a = Ug(this.M, e, b, d)) : (b = J(b), a = Rg(this.M, e, b, d)) : c ? (d = dd(b, function (a) {
            return J(a)
        }), a = this.M.$d(e, d)) : (d = J(b), a = this.M.Ra(e, d));
        d = e;
        0 < a.length && (d = hh(this, e));
        Ve(this.Z, d, a)
    };
    h.Ad = function (a) {
        eh(this, "connected", a);
    ...
    h.Db = function (a, b, c, d) {
        this.f("set", {path: a.toString(), value: b, Bg: c});
        var e = gh(this);
        b = J(b, c);
        var e = Gf(b, e), f = this.zd++, e = this.M.Fa(a, e, f, !0);
        Se(this.Z, e);
        var g = this;
    ...
    h.update = function (a, b, c) {
        ...
        if (d)ib("update() called with empty data.  Don't do anything."), jh(c, "ok"); else {
            var g = this.zd++, k = this.M.ae(a, f, g);
            Se(this.Z, k);
            var l = this;
            Ie(this.S, a.toString(), b, function (b, d) {
    ...
    function ih(a) {
        ...
        var b = gh(a), c = [];
        Pe(Ff(a.ga, b), S, function (b, e) {
            c = c.concat(a.M.Ra(b, e));
            var f = kh(a, b);
            hh(a, f)
        });
        a.ga = new Ne;
    ...
    function lh(a, b, c, d) {
        var e = J(c);
        De(a.S, b.toString(), e.N(!0), function (c, g) {
            "ok" === c && a.ga.ic(b, e);
            jh(d, c, g)
        })
    }
    ...
    function nh(a, b, c, d) {
        var e = !0, f;
        for (f in c)e = !1;
        e ? (ib("onDisconnect().update() called with empty data.  Don't do anything."), jh(d, "ok")) : Ge(a.S, b.toString(), c, function (e, f) {
    ...
    h.Me = function (a) {
        if ("undefined" !== typeof console) {
            a ? (this.Nd || (this.Nd = new Fd(this.Pa)), a = this.Nd.get()) : a = this.Pa.get();
            var b = Ma(wd(a), function (a, b) {
    ...
    function oh(a, b, c, d, e) {
        ...
        g.zb("value", f);
        c = {
            path: b, update: c, H: d, status: null, lf: fb(), Qe: e, rf: 0, Vd: function () {
                g.bc("value", f)
            }, Yd: null, ra: null, fd: null, gd: null, hd: null
        };
        d = a.M.xa(b, void 0) || K;
        c.fd = d;
        d = c.update(d.N());
        if (n(d)) {
            Rb("transaction failed: Data returned ", d);
            c.status = 1;
            e = Ec(a.pc, b);
            var k = e.ta() || [];
            k.push(c);
            Fc(e, k);
            "object" === typeof d && null !== d && u(d, ".priority") ? (k = v(d, ".priority"), x(Pb(k), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")) :
                k = (a.M.xa(b) || K).O().N();
            e = gh(a);
            d = J(d, k);
            e = Gf(d, e);
    ...
    function hh(a, b) {
        var c = th(a, b), d = c.path(), c = rh(a, c);
        uh(a, c, d);
        return d
    }
    ...
    function uh(a, b, c) {
        if (0 !== b.length) {
            for (var d = [], e = [], f = La(b, function (a) {
                ...
                if (5 === k.status)m = !0, r = k.Yd, e = e.concat(a.M.Ea(k.ra, !0)); else if (1 === k.status)if (25 <= k.rf)m = !0, r = "maxretry", e = e.concat(a.M.Ea(k.ra, !0)); else {
                    var s = a.M.xa(k.path, f) || K;
                    k.fd = s;
                    var y = b[g].update(s.N());
                    n(y) ? (Rb("transaction failed: Data returned ", y), l = J(y), "object" === typeof y && null != y && u(y,
                        ".priority") || (l = l.ib(s.O())), s = k.ra, y = gh(a), y = Gf(l, y), k.gd = l, k.hd = y, k.ra = a.zd++, Qa(f, s), e = e.concat(a.M.Fa(k.path, y, k.ra, k.Qe)), e = e.concat(a.M.Ea(s, !0))) : (m = !0, r = "nodata", e = e.concat(a.M.Ea(k.ra, !0)))
                }
                Ve(a.Z, c, e);
                e = [];
    ...
    function th(a, b) {
        for (var c, d = a.pc; null !== (c = G(b)) && null === d.ta();)d = Ec(d, c), b = R(b);
        return d
    }
    ...
    function wh(a, b) {
        var c = b.ta();
        if (null !== c) {
            for (var d = [], e = [], f = -1, g = 0; g < c.length; g++)4 !== c[g].status && (2 === c[g].status ? (x(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].Yd = "set") : (x(1 === c[g].status, "Unexpected transaction status in abort"), c[g].Vd(), e = e.concat(a.M.Ea(c[g].ra, !0)), c[g].H && d.push(q(c[g].H, null, Error("set"), !1, null))));
            -1 === f ? Fc(b, null) : c.length = f + 1;
            Ve(a.Z, b.path(), e);
            for (g = 0; g < d.length; g++)Db(d[g])
        }
    };
    ...
    xh.prototype.interrupt = xh.prototype.tb;
    xh.prototype.kc = function () {
        for (var a in this.jc)this.jc[a].kc()
    };
    xh.prototype.resume = xh.prototype.kc;
    function yh(a) {
        var b = this;
        this.tc = a;
        this.Qd = "*";
        jf() ? this.Hc = this.sd = af() : (this.Hc = window.opener, this.sd = window);
        if (!b.Hc)throw"Unable to find relay frame";
        bf(this.sd, "message", q(this.cc, this));
        bf(this.sd, "message", q(this.hf, this));
        try {
            zh(this, {a: "ready"})
        } catch (c) {
            bf(this.Hc, "load", function () {
                zh(b, {a: "ready"})
            })
        }
        bf(window, "unload", q(this.dg, this))
    }

    function zh(a, b) {
        b = t(b);
        jf() ? a.Hc.doPost(b, a.Qd) : a.Hc.postMessage(b, a.Qd)
    }
    ...
    yh.prototype.cc = function (a) {
        ...
        c && "request" === c.a && (cf(window, "message", this.cc), this.Qd = a.origin, this.tc && setTimeout(function () {
            b.tc(b.Qd, c.d, function (a, c) {
                b.If = !c;
                b.tc = void 0;
                zh(b, {a: "response", d: a, forceKeepWindowOpen: c})
            })
        }, 0))
    };
    yh.prototype.dg = function () {
        try {
            cf(this.sd, "message", this.hf)
        } catch (a) {
        }
        this.tc && (zh(this, {a: "error", d: "unknown closed window"}), this.tc = void 0);
        try {
            window.close()
        } catch (b) {
        }
    };
    yh.prototype.hf = function (a) {
    ...
    Y.forceLongPolling = Y.Qf;
    Y.Rf = function () {
        Xd = !0
    };
    Y.forceWebSockets = Y.Rf;
    Y.qg = function (a, b) {
        a.g.S.Ke = b
    };
    Y.setSecurityDebugCallback = Y.qg;
    Y.Me = function (a, b) {
        a.g.Me(b)
    };
    Y.stats = Y.Me;
    ...
    Y.setAuthenticationServer = Y.og;
    function Z(a, b) {
        this.Sc = a;
        this.Ca = b
    }
    ...
    Z.prototype.update = function (a, b) {
        ...
        Yb("Firebase.onDisconnect().update", this.Ca);
        if (ea(a)) {
        ...
        Tb("Firebase.onDisconnect().update", a);
    ...
    $.rc = ve;
    $.DataConnection = $.rc;
    ve.prototype.sg = function (a, b) {
        this.wa("q", {p: a}, b)
    };
    $.rc.prototype.simpleListen = $.rc.prototype.sg;
    ve.prototype.Nf = function (a, b) {
        this.wa("echo", {d: a}, b)
    };
    $.rc.prototype.echo = $.rc.prototype.Nf;
    ve.prototype.interrupt = ve.prototype.tb;
    $.zf = ge;
    $.RealTimeConnection = $.zf;
    ge.prototype.sendRequest = ge.prototype.wa;
    ge.prototype.close = ge.prototype.close;
    $.Tf = function (a) {
        var b = ve.prototype.put;
        ve.prototype.put = function (c, d, e, f) {
            n(f) && (f = a());
            b.call(this, c, d, e, f)
        };
        return function () {
    ...
    function O(a, b) {
        var c, d, e;
        if (a instanceof dh)c = a, d = b; else {
            ...
            e = d.toString();
            var f;
            !(f = !p(c.host) || 0 === c.host.length || !Ob(c.yb)) && (f = 0 !== e.length) && (e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), f = !(p(e) && 0 !== e.length && !Nb.test(e)));
            if (f)throw Error(E("new Firebase", 1, !1) + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');
            if (b)if (b instanceof xh)e = b; else if (p(b))e = xh.Qb(), c.Gd = b; else throw Error("Expected a valid Firebase.Context for second argument to new Firebase()");
            else e = xh.Qb();
            f = c.toString();
            var g = v(e.jc, f);
            g || (g = new dh(c), e.jc[f] = g);
            c = g
        }
        M.call(this, c, d, mc, !1)
    }

    na(O, M);
    var Bh = O, Ch = ["Firebase"], Dh = aa;
    Ch[0]in Dh || !Dh.execScript || Dh.execScript("var " + Ch[0]);
    for (var Eh; Ch.length && (Eh = Ch.shift());)!Ch.length && n(Bh) ? Dh[Eh] = Bh : Dh = Dh[Eh] ? Dh[Eh] : Dh[Eh] = {};
    ...
    O.prototype.key = function () {
        ...
        var a;
        this.path.e() ? a = null : (a = this.path, a = a.ba < a.m.length ? a.m[a.m.length - 1] : null);
        return a
    };
    ...
    O.prototype.Db = function (a, b, c) {
        ...
        Yb("Firebase.setWithPriority", this.path);
        Qb("Firebase.setWithPriority", a, !1);
        Ub("Firebase.setWithPriority", 2, b);
    ...
    O.prototype.transaction = function (a, b, c) {
        ...
        Yb("Firebase.transaction", this.path);
    ...
    O.prototype.T = function (a, b, c) {
        ...
        xf(this.g.T, a, {}, {remember: "none"}, b, c)
    };
    ...
    O.prototype.onAuth = O.prototype.$f;
    ...
    O.prototype.Ef = function (a, b, c) {
        ...
        $b("Firebase.authWithOAuthPopup", 1, a);
        F("Firebase.authWithOAuthPopup", 2, b, !1);
        ac("Firebase.authWithOAuthPopup", 3, c, !0);
        Cf(this.g.T, a, c, b)
    };
    ...
    O.prototype.Ff = function (a, b, c) {
        ...
        $b("Firebase.authWithOAuthRedirect", 1, a);
        F("Firebase.authWithOAuthRedirect", 2, b, !1);
        ac("Firebase.authWithOAuthRedirect", 3, c, !0);
        var d = this.g.T;
        Af(d);
        var e = [qf], f = Ze(c);
        "anonymous" === a || "firebase" === a ? B(b, V("TRANSPORT_UNAVAILABLE")) : (Ba.set("redirect_client_options", f.ed), Bf(d, e, "/auth/" + a, f, b))
    };
    ...
    O.prototype.Gf = function (a, b, c, d) {
        ...
        $b("Firebase.authWithOAuthToken", 1, a);
        F("Firebase.authWithOAuthToken", 3, c, !1);
        ac("Firebase.authWithOAuthToken", 4, d, !0);
        p(b) ? ($b("Firebase.authWithOAuthToken", 2, b), zf(this.g.T, a + "/token", {access_token: b}, d, c)) : (ac("Firebase.authWithOAuthToken", 2, b, !1), zf(this.g.T, a + "/token", b, d, c))
    };
    ...
    O.prototype.Cf = function (a, b) {
        ...
        ac("Firebase.authAnonymously", 2, b, !0);
        zf(this.g.T, "anonymous", {}, b, a)
    };
    O.prototype.authAnonymously = O.prototype.Cf;
    O.prototype.Hf = function (a, b, c) {
        D("Firebase.authWithPassword", 2, 3, arguments.length);
        ac("Firebase.authWithPassword", 1, a, !1);
        bc("Firebase.authWithPassword", a, "email");
        bc("Firebase.authWithPassword", a, "password");
        F("Firebase.authAnonymously", 2, b, !1);
        ac("Firebase.authAnonymously", 3, c, !0);
        zf(this.g.T, "password", a, c, b)
    };
    O.prototype.authWithPassword = O.prototype.Hf;
    O.prototype.je = function (a, b) {
        D("Firebase.createUser", 2, 2, arguments.length);
        ac("Firebase.createUser", 1, a, !1);
        bc("Firebase.createUser", a, "email");
        bc("Firebase.createUser", a, "password");
    ...
    O.prototype.Ie = function (a, b) {
        ...
        ac("Firebase.removeUser", 1, a, !1);
        bc("Firebase.removeUser", a, "email");
        bc("Firebase.removeUser", a, "password");
    ...
    O.prototype.ee = function (a, b) {
        ...
        ac("Firebase.changePassword", 1, a, !1);
        bc("Firebase.changePassword", a, "email");
        bc("Firebase.changePassword", a, "oldPassword");
        bc("Firebase.changePassword", a, "newPassword");
    ...
    O.prototype.Je = function (a, b) {
        ...
        ac("Firebase.resetPassword", 1, a, !1);
        bc("Firebase.resetPassword", a, "email");
    ...
    function ob(a, b) {
        ...
        !0 === a ? ("undefined" !== typeof console && ("function" === typeof console.log ? mb = q(console.log, console) : "object" === typeof console.log && (mb = function (a) {
            console.log(a)
        })), b && Ba.set("logging_enabled", !0)) : a ? mb = a : (mb = null, Ba.remove("logging_enabled"))
    }
