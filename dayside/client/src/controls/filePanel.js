                ...
                .jstree({
                    ...
                    contextmenu: {
                        ...
                        items: function (node) {
                            ...
                            var res = {};
                            res["link"] = {
                                label: "Open web location", action: function () {
                                    window.open(path);
                                }
                            }

                            res["download"] = {
                                label: 'Download', action: function (e) {
                                    var array_path = [];
                                    var obj = this.data.ui.selected;
                                    for (i = 0; i < obj.length; i++) {
                                        array_path[i] = this.data.ui.selected[i].getAttribute("rel");
                                    }
                                    window.open(window.FileApi.ajax_url + '?' + $.param({
                                            path: array_path,
                                            _type: 'download'
                                        }));
                                }
                            ...
                            if (node.data("folder")) {
                                res = $.extend(res, {
                                    "refresh": {
                                        label: "Refresh", separator_before: true, action: function () {
                                    ...
                                    "upload": {
                                        label: "Upload", separator_before: true, action: function () {
                                            if (!me.uploadDialog) {
                                                me.uploadDialog = teacss.ui.uploadDialog({
                                                    jupload: me.options.jupload,
                                                    jupload_data: me.options.jupload_data
                                    ...
                                    "create": {
                                        ...
                                        submenu: {
                                            "createFile": {
                                                label: "Create file", action: function () {
                                            ...
                                            "createFolder": {
                                                label: "Create folder", action: function () {
                            ...
                            if (path != FileApi.root) {
                                if (path.split(".").pop() == 'zip') res['unzip'] = {
                                    label: "Unpack", action: function () {
                                ...
                                res["rename"] = {
                                    label: "Rename", separator_before: true, action: function () {
                        ...
                        move: {
                            check_move: function (m) {
                                ...
                                m.o.each(function () {
                                    ...
                                    if (!parent)
                                        parent = rel;
                                    else if (parent != rel) valid = false;
                                });
